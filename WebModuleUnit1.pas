...
procedure TWebModule1.WebModule1DefaultHandlerAction(Sender: TObject;
  Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
var
  FilePath, RequestedFile, BasePath: string;
...
begin
  ...
  BasePath := 'C:\Users\Bill jenkins\Documents\Embarcadero\Studio\Projects\PSPEngine\Win32\Debug\www' + PathDelim;
  FilePath := BasePath + StringReplace(RequestedFile, '/', PathDelim, [rfReplaceAll]);

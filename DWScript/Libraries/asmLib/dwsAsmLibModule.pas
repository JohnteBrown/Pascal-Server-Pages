...
uses
   ...
   dwsLanguageExtension, dwsUtils, dwsComp, dwsCompiler, dwsScriptSource,
   dwsTokenizer, dwsTokenTypes, dwsExprs, dwsSymbols, dwsErrors, dwsCoreExprs,
   dwsStack, dwsStrings, dwsXPlatform;

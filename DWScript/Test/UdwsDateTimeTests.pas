...
begin
  ...
  CheckEquals('2009-02-13 23:31:30.000',
    FormatDateTime('yyyy-mm-dd hh:nn:ss.zzz', t.AsUTCDateTime));
  t.IncMilliseconds(123);
  CheckEquals('2009-02-13 23:31:30.123',
    FormatDateTime('yyyy-mm-dd hh:nn:ss.zzz', t.AsUTCDateTime));
...
begin
  ...
  try
    CheckFalse(fmt.TryStrToDateTime('dd mmmm yyyy', '18 Dec 2019', dt, tzUTC),
      'parse 1 fail');
    CheckTrue(fmt.TryStrToDateTime('dd mmm yyyy', '18 Dec 2019', dt, tzUTC),
      'parse 1 pass');
    CheckEquals('18.12.2019 00:00:00', fmt.FormatDateTime('dd.mm.yyyy hh:nn:ss',
      dt, tzUTC), 'format 1');

    CheckFalse(fmt.TryStrToDateTime('m/d/yyyy h:nn:ss ampm',
      '1/2/2021 1:30:40 mm', dt, tzUTC), 'parse 2 fail');
    CheckTrue(fmt.TryStrToDateTime('m/d/yyyy h:nn:ss ampm',
      '1/2/2021 1:30:40 am', dt, tzUTC), 'parse 2 pass');
    CheckEquals('02.01.2021 01:30:40', fmt.FormatDateTime('dd.mm.yyyy hh:nn:ss',
      dt, tzUTC), 'format 2');

    CheckTrue(fmt.TryStrToDateTime('m/d/yyyy h:nn:ss ampm',
      '1/2/2021 1:30:40 PM', dt, tzUTC), 'parse 4 pass');
    CheckEquals('02.01.2021 01:30:40 PM',
      fmt.FormatDateTime('dd.mm.yyyy hh:nn:ss ampm', dt, tzUTC), 'format 3');

    CheckTrue(fmt.TryStrToDateTime('h:m:s ampm d yyyy m',
      '12:22:33 pm 4 2020 5', dt, tzUTC), 'parse 5 pass');
    CheckEquals('05.05.2020 00:22:33', fmt.FormatDateTime('dd.mm.yyyy hh:nn:ss',
      dt, tzUTC), 'format 4');

    CheckTrue(fmt.TryStrToDateTime('_yyyy_mm_dd_', '_2020_01_02_', dt, tzLocal),
      'litterals pass');
    CheckFalse(fmt.TryStrToDateTime('_yyyy_mm_dd_', '-2020_01_02_', dt,
      tzLocal), 'litterals fail head 1');
    CheckFalse(fmt.TryStrToDateTime('_yyyy_mm_dd_', '2020_01_02_', dt, tzLocal),
      'litterals fail head 2');
    CheckFalse(fmt.TryStrToDateTime('_yyyy_mm_dd_', '_2020-01_02_', dt,
      tzLocal), 'litterals fail mid 1');
    CheckFalse(fmt.TryStrToDateTime('_yyyy_mm_dd_', '_202001_02_', dt, tzLocal),
      'litterals fail mid 2');
    CheckFalse(fmt.TryStrToDateTime('_yyyy_mm_dd_', '_2020_01_02-', dt,
      tzLocal), 'litterals fail tail 1');
    CheckFalse(fmt.TryStrToDateTime('_yyyy_mm_dd_', '_2020_01_02', dt, tzLocal),
      'litterals fail tail 2');

    CheckTrue(fmt.TryStrToDateTime('dd mmm yy', '18 dec 19', dt, tzUTC),
      'two digits year');
    CheckEquals('18.12.19', fmt.FormatDateTime('dd.mm.yy', dt, tzUTC),
      'format two digits');
    CheckTrue(fmt.TryStrToDateTime('d m yy', '8 12 2019', dt, tzUTC),
      'two digits year with 4 actual');
    CheckEquals('08.12.19', fmt.FormatDateTime('dd.mm.yy', dt, tzUTC),
      'format two digits bis');
    CheckTrue(fmt.TryStrToDateTime('dd mmm yy', '12 jan 99', dt, tzUTC),
      'two digits year wrap');
    CheckEquals('12.1.1999', fmt.FormatDateTime('dd.m.yyyy', dt, tzUTC),
      'format four digits wrap');
    CheckEquals('12.1.99', fmt.FormatDateTime('dd.m.yy', dt, tzUTC),
      'format two digits wrap');

    CheckTrue(fmt.TryStrToDateTime('yymmdd', '240605', dt, tzLocal),
      'parse yymmdd 240605');
    CheckEquals('05.06.24', fmt.FormatDateTime('dd.mm.yy', dt, tzLocal),
      'value 230605');
    CheckFalse(fmt.TryStrToDateTime('yymmdd', '241305', dt, tzUTC),
      'parse yymmdd 241305');
    CheckFalse(fmt.TryStrToDateTime('yymmdd', '240631', dt, tzUTC),
      'parse yymmdd 240631');
  finally
    fmt.Free;
  end;
...
begin
  ...
  try
    ...
    begin
      mutated := ref;
      mutated[i] := '_';
      CheckFalse(fmt.TryStrToDateTime('hh:mm:ss dd/mm/yyyy', mutated, dt,
        tzLocal), mutated);
      mutated := ref;
      Delete(mutated, i, 1);
      CheckFalse(fmt.TryStrToDateTime('hh:mm:ss dd/mm/yyyy', mutated, dt,

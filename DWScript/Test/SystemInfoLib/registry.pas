...
PrintLn(Registry.SubKeys(HKEY.CurrentUser, '\Software\DWScript\Test')
  .Join(','));
...
PrintLn(Registry.WriteValue(HKEY.CurrentUser, '\Software\DWScript\Test',
  'Hello', 'World'));
PrintLn(Registry.WriteValue(HKEY.CurrentUser, '\Software\DWScript\Test',
  '123', 123));
...
PrintLn('Read Values:');
PrintLn(Registry.ReadValue(HKEY.CurrentUser, '\Software\DWScript\Test',
  'Hello', '?'));
PrintLn(Registry.ReadValue(HKEY.CurrentUser, '\Software\DWScript\Test',
  '123', 456));

PrintLn('Delete Value:');
PrintLn(Registry.DeleteValue(HKEY.CurrentUser, '\Software\DWScript\Test',
  'Hello'));
PrintLn(Registry.ValueNames(HKEY.CurrentUser, '\Software\DWScript\Test')
  .Join(','));
PrintLn(Registry.ReadValue(HKEY.CurrentUser, '\Software\DWScript\Test',
  'Hello', '?'));

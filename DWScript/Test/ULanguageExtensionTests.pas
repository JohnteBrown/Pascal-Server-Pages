...
type
  ...
  public
    function FindUnknownName(compiler: TdwsCompiler; const name: String)
      : TSymbol; override;
  end;
...
// Call
//
procedure TCallableAutoExternal.Call(exec: TdwsProgramExecution;
  func: TFuncSymbol);
begin
...
// FindUnknownName
//
function TAutoExternalValues.FindUnknownName(compiler: TdwsCompiler;
...
begin
  externalSym := TExternalVarSymbol.Create(name,
    compiler.CompilerContext.TypString);

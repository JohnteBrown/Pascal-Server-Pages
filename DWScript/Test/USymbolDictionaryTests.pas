...
// DoOnInclude
//
procedure TSymbolDictionaryTests.DoOnInclude(const scriptName: String;
...
var
  prog: IdwsProgram;
begin
  prog := FCompiler.Compile('procedure Test(a1 : Integer); forward;'#13#10 +
    'procedure Test(a1 : Integer); begin end;'#13#10);
  CheckEquals('[{"symbol":{"name":"a1","class":"TParamSymbol"},"positions":[' +
...
var
  prog: IdwsProgram;
begin
  prog := FCompiler.Compile('procedure Test1(a1 : Integer); forward;'#13#10 +
...
var
  prog: IdwsProgram;
begin
  prog := FCompiler.Compile('type TTest = class procedure Test; end;'#13#10 +
...
var
  prog: IdwsProgram;
begin
  prog := FCompiler.Compile('type TTest = class partial end;'#13#10 +
    'type TTest = class partial end;'#13#10);
  CheckEquals('[{"symbol":{"name":"TTest","class":"TClassSymbol"},"positions":['
    + '{"usages":["suDeclaration"],"position":" [line: 1, column: 6]"},' +
...
var
  prog: IdwsProgram;
begin
  prog := FCompiler.Compile('StrSplit('', '').Map(Trim);');
  CheckEquals
...
begin
  ...
  for symPosList in prog.SymbolDictionary do
    CheckEquals(2, symPosList.Count, 'A declared + reference for ' +
      symPosList.Symbol.Name);
  ...
  for symPosList in prog.SymbolDictionary do
    CheckEquals(2, symPosList.Count, 'B declared + reference for ' +
      symPosList.Symbol.Name);
end;
...
begin
  prog := FCompiler.Compile('type TTest = class'#13#10 +
    ...
    'procedure Test(a3 : Boolean); overload;'#13#10 + 'end;'#13#10 +
  ...
  prog := FCompiler.Compile('type TTest = class'#13#10 +
    ...
    'procedure Test(a2, a1 : String); overload;'#13#10 + 'end;'#13#10 +
...
begin
  ...
  CheckEquals(1, prog.SymbolDictionary.FindSymbolUsage('TTest', suForward)
    .ScriptPos.Line, 'forward');
  CheckEquals(2, prog.SymbolDictionary.FindSymbolUsage('TTest', suDeclaration)
    .ScriptPos.Line, 'declaration');
end;
...
begin
  prog := FCompiler.Compile('type TTest = class partial;'#13#10 +
    'type TTest = class partial end;' + 'type TTest = class partial end;');

  CheckEquals('', prog.Msgs.AsInfo, 'compile');
  symPosList := prog.SymbolDictionary.FindSymbolPosList('TTest');
  CheckTrue(symPosList.Items[0].SymbolUsages = [suForward], 'forward');
  CheckTrue(symPosList.Items[1].SymbolUsages = [suDeclaration],
    'declaration 1');
  CheckTrue(symPosList.Items[2].SymbolUsages = [suDeclaration],
    'declaration 2');
end;
...
begin
  ...
  Check(prog.SymbolDictionary.FindSymbolUsageOfType('Test', TFuncSymbol,
    suForward) = nil, 'Forward');
  CheckEquals(1, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suDeclaration).ScriptPos.Line, 'a Declaration');
  CheckEquals(1, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suImplementation).ScriptPos.Line, 'a Implementation');

  prog := FCompiler.Compile('procedure Test; forward;'#13#10 +
    'procedure Test; begin end;');

  CheckEquals(1, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suForward).ScriptPos.Line, 'b Forward');
  CheckEquals(1, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suDeclaration).ScriptPos.Line, 'b Declaration');
  CheckEquals(2, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suImplementation).ScriptPos.Line, 'b Implementation');

  prog := FCompiler.Compile('unit Test; interface'#13#10 +
    'procedure Test;'#13#10 + 'implementation'#13#10 +
    'procedure Test; begin end;');

  CheckEquals(2, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suForward).ScriptPos.Line, 'c Forward');
  CheckEquals(2, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suDeclaration).ScriptPos.Line, 'c Declaration');
  CheckEquals(4, prog.SymbolDictionary.FindSymbolUsageOfType('Test',
    TFuncSymbol, suImplementation).ScriptPos.Line, 'c Implementation');
end;
...
begin
  prog := FCompiler.Compile
    ('type TBaseClass = class procedure Foo; virtual; end;'#13#10 +
    'type TDerivedClass = class(TBaseClass) procedure Foo; override; end;'#13#10
    + 'procedure TDerivedClass.Foo; begin'#13#10 + 'inherited;'#13#10 +
    'inherited Foo;'#13#10 + 'end;');
  ...
  Check(symPosList[0].SymbolUsages = [suDeclaration],
    'TBaseClass Line 1 usage');
  ...
  Check(symPosList[2].SymbolUsages = [suReference, suImplicit],
    'TBaseClass Line 4 usage');
  ...
  Check(symPosList[0].SymbolUsages = [suDeclaration],
    'TDerivedClass Line 2 usage');

  CheckEquals(3, symPosList[1].ScriptPos.Line, 'TDerivedClass Line 3');
  Check(symPosList[1].SymbolUsages = [suImplementation],
    'TDerivedClass Line 3 usage');
end;
...
begin
  prog := FCompiler.Compile('type TTest = class end;'#13#10 +
    'procedure Test(a : TTest); begin end;'#13#10 + 'Test(nil);'#13#10);
...
begin
  prog := FCompiler.Compile('type TTest = class end;'#13#10 +
    'procedure Test(a : TTest = nil); begin end;'#13#10 + 'Test();'#13#10);
  CheckEquals('', prog.Msgs.AsInfo);

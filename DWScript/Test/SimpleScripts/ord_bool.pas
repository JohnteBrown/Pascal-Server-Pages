...
var
i := 23;
PrintLn(Ord((i and 16) <> 0) * 16 + Ord((i and 8) <> 0) * 8 +
  Ord((i and 4) <> 0) * 4 + Ord((i and 2) <> 0) * 2 + Ord((i and 1) <> 0) * 1);
PrintLn(Ord((i and 16) = 0) * 16 + Ord((i and 8) = 0) * 8 + Ord((i and 4) = 0) *
  4 + Ord((i and 2) = 0) * 2 + Ord((i and 1) = 0) * 1);

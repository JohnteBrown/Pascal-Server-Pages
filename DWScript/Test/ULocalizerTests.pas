...
uses Windows, Classes, SysUtils, dwsXPlatformTests, dwsComp, dwsCompiler,
  dwsExprs,
...
type
  ...
  public
    ...
    procedure DoLocalize(Sender: TObject; const aString: String;
      var Result: String);
...
// DoLocalize
//
procedure TLocalizerTests.DoLocalize(Sender: TObject; const aString: String;
  var Result: String);
begin
  Result := '[' + aString + ']';
end;

...
{$RTTI EXPLICIT METHODS([vcPublic, vcPublished]) PROPERTIES([vcPublic, vcPublished]) FIELDS([vcPublic, vcPublished])}
  ...
  published
    ...
    function CallWithArrayOfInteger(const Value
      : TDynamicParamOfInteger): string;
    function CallWithArrayOfString(const Value: TDynamicParamOfString): string;
    function CallWithArrayOfVariant(const Value
      : TDynamicParamOfVariant): string;
  end;
...
function TDynamicTestClass.CallWithArrayOfFloat(const Value
  : TDynamicParamOfFloat): string;
var
  Index: Integer;
begin
  Result := sLineBreak;
  for Index := Low(Value) to High(Value) do
    Result := Result + '[' + IntToStr(Index) + '] ' + FloatToStr(Value[Index]) +
      sLineBreak;
end;
...
begin
  Result := sLineBreak;
  for Index := Low(Value) to High(Value) do
    Result := Result + '[' + IntToStr(Index) + '] ' + IntToStr(Value[Index]) +
      sLineBreak;
end;

function TDynamicTestClass.CallWithArrayOfString(const Value
  : TDynamicParamOfString): string;
var
  Index: Integer;
begin
  Result := sLineBreak;
...
begin
  Result := sLineBreak;
  for Index := Low(Value) to High(Value) do
    Result := Result + '[' + IntToStr(Index) + '] ' + VarToStr(Value[Index]) +
      sLineBreak;
end;
...
const
  ...
  cDynamicParamTestResult = 'DynamicParamOfFloat: '#$D#$A + '[0] 0.1'#$D#$A +
    '[1] 0.2'#$D#$A + '[2] 0.3'#$D#$A#$D#$A + 'DynamicParamOfInteger: '#$D#$A +
    '[0] 1'#$D#$A + '[1] 2'#$D#$A + '[2] 3'#$D#$A#$D#$A +
    'DynamicParamOfString: '#$D#$A + '[0] hello'#$D#$A + '[1] world'#$D#$A +
    '[2] from'#$D#$A + '[3] DWScript!'#$D#$A#$D#$A +
    'DynamicParamOfVariant: '#$D#$A + '[0] 0.02'#$D#$A + '[1] 5'#$D#$A +
    '[2] hello world!'#$D#$A + '[3] '#$D#$A#$D#$A;
...
const
  ...
  cDynamicParamTestResultDirectPass = 'DynamicParamOfFloat: '#$D#$A +
    '[0] 0.1'#$D#$A + '[1] 0.2'#$D#$A + '[2] 0.3'#$D#$A#$D#$A +
    'DynamicParamOfInteger: '#$D#$A + '[0] 1'#$D#$A + '[1] 2'#$D#$A +
    '[2] 3'#$D#$A#$D#$A + 'DynamicParamOfString: '#$D#$A + '[0] hello'#$D#$A +
    '[1] world'#$D#$A + '[2] from'#$D#$A + '[3] DWScript!'#$D#$A#$D#$A +
    'DynamicParamOfVariant: '#$D#$A + '[0] 0.02'#$D#$A + '[1] 5'#$D#$A +
    '[2] hello world!'#$D#$A + '[3] '#$D#$A#$D#$A;
...
begin
  ...
  CheckEquals(cDynamicParamTestResultDirectPass, LExec.Result.ToString,
    'Exec Result');
end;
  ...
  try
    ...
    try
      prog := FCompiler.Compile('Items.Add("Hello");'#13#10 +
        'PrintLn(Items.Strings[0]);'#13#10 + 'Items.Strings[0]:="World";'#13#10
...
begin
  ...
  try
    ...
    try
      prog := FCompiler.Compile('Items.Add("Hello");'#13#10 +
        'PrintLn(Items[0]);'#13#10 + 'Items[0]:="World";'#13#10 +
        'PrintLn(Items[0]);');
      try
        CheckEquals('', prog.Msgs.AsInfo, 'compile');
        exec := prog.Execute(0);
...
function TStrings_GetValues(instance: Pointer;
  ...
  try
    ...
    try
      prog := FCompiler.Compile('Items.Add("Hello=World");'#13#10 +
        ...
        'Items.Values["Hello"]:="Moon";'#13#10 + 'PrintLn(Items[0]);');
      try
        CheckEquals('', prog.Msgs.AsInfo, 'compile');
        exec := prog.Execute(0);
        CheckEquals('', exec.Msgs.AsInfo, 'exec');
        CheckEquals('World'#13#10'Hello=Moon'#13#10, exec.Result.ToString,
          'result');
      finally
        prog := nil;
      end;
...
const
  cTestCode = 'var c := new TClassWithEnumeration;'#13#10 +
    'c.EnumField := seOne;'#13#10 + 'Print(c.TestFunc(seOne));'#13#10 +
...
const
  cSimpleClassTest = 'var c : TSimpleClass = TSimpleClass.Create;'#13#10 +
    'Print(IntToStr(c.Value));'#13#10 + 'c.Value:=1;'#13#10 +
    'Print(IntToStr(c.Value));'#13#10 + 'c.IncValue;'#13#10 +
    'Print(IntToStr(c.Value));'#13#10 + 'c.Multiply(3);'#13#10 +
    'Print(IntToStr(c.Value));'#13#10 + 'c.DecValue;'#13#10 +
    'Print(IntToStr(c.Value));'#13#10 + 'Print(c.InverseBoolean(True));'#13#10 +
  ...
  cSimpleClassFailNullValueTest =
    'var c : TSimpleClass = TSimpleClass.Create;'#13#10 + 'c.NullValue;'#13#10;
var
  prog: IdwsProgram;
  exec: IdwsProgramExecution;
begin
...
const
  cSimpleEnumeration = 'Print(IntToStr(Ord(seZero)));'#13#10 +
    'Print(IntToStr(Ord(seOne)));'#13#10 + 'Print(IntToStr(Ord(seTwo)));'#13#10;
...
begin
  ...
  CheckEquals('1, 2, 3, 4, 2, 0, 0, 1, 1, -1, -1, 2, 2', exec.Result.ToString,
    'Exec Result');
end;
...
begin
  ...
  prog := FCompiler.Compile('type TTest = class (ISimpleInterface)'#13#10 +
    ...
    'end;'#13#10 + 'var i : ISimpleInterface := new TTest;'#13#10 +
    'Print(i.GetHello);');
...
begin
  prog := FCompiler.Compile('var v : RTTIVariant = GetSimpleInstance;'#13#10 +
    'PrintLn(v.Value);'#13#10 + 'v.IncValue();'#13#10 +
    'PrintLn(v.Value);'#13#10 + 'v.Value:=456;'#13#10 +
    'PrintLn(v.Value);'#13#10 + 'v.Free();'#13#10);
  ...
  CheckEquals('', prog.Msgs.AsInfo, 'Exec Msgs');
  CheckEquals('123'#13#10'124'#13#10'456'#13#10, exec.Result.ToString,
    'Exec Result');
end;
...
begin
  prog := FCompiler.Compile
    ('var v : RTTIVariant<URTTIExposeTests.TSimpleClass> = GetSimpleInstance;'#13#10
    + 'PrintLn(v.Value);'#13#10 + 'v.IncValue();'#13#10 +
    'PrintLn(v.Value);'#13#10 + 'v.Value:=456;'#13#10 +
    'PrintLn(v.Value);'#13#10 + 'v.Free();'#13#10);
...
begin
  ...
  CheckEquals
    ('Syntax Error: Connector "RttiVariant" specialization to "URTTIExposeTests.TBug" failed [line: 1, column: 42]'#13#10,
    prog.Msgs.AsInfo, 'Specialize');

  prog := FCompiler.Compile
    ('var v : RTTIVariant<URTTIExposeTests.TSimpleClass>;'#13#10 +
    'PrintLn(v.Bug);'#13#10);

  CheckEquals
    ('Syntax Error: Member "Bug" readonly or not found in connector "RttiVariant <URTTIExposeTests.TSimpleClass>" [line: 2, column: 14]'#13#10,
...
begin
  ...
  try
    ...
    prog := FCompiler.Compile('var f := ConnectForm("ConnectorTestForm");'#13#10
      + 'Print(f.Name);'#13#10 + 'f.Name := "Hello";'#13#10 +
    ...
    CheckEquals('Label2', TLabel(form.Components[1]).Caption,
      'label 2 caption');
  finally
    form.Free;
  end;
...
begin
  prog := FCompiler.Compile('var v : RTTIVariant = GetSimpleInstance;'#13#10 +
    'PrintLn(v.Value);'#13#10 + 'v.Add(1);'#13#10 + 'PrintLn(v.Value);'#13#10 +
    'v.Add(10, 100);'#13#10 + 'PrintLn(v.Value);'#13#10 + 'v.Free();'#13#10);
  ...
  CheckEquals('', prog.Msgs.AsInfo, 'Exec Msgs');
  CheckEquals('123'#13#10'124'#13#10'234'#13#10, exec.Result.ToString,
    'Exec Result');
end;
  ...
  try
    ...
    try
      prog := FCompiler.Compile('PrintLn(FieldOne.Value);'#13#10 +
        'FieldOne.IncValue();'#13#10 + 'PrintLn(FieldOne.Value);'#13#10 +
        'FieldOne.IncValue;'#13#10 + 'PrintLn(FieldOne.Value);'#13#10 +
        'PrintLn(FieldOne.InverseBoolean(True));'#13#10 +
        'PrintLn(FieldTwo);'#13#10 + 'PrintLn(FieldTwo[1]);'#13#10 +
        'PrintLn(FieldOne.ClassName());'#13#10 + 'PrintLn(FieldBool);'#13#10 +
        'PrintLn(FieldFloat);'#13#10 + 'PrintLn(FieldInteger*2);'#13#10 +
      ...
      try
        ...
        CheckEquals('123'#13#10'124'#13#10'125'#13#10'False'#13#10 +
          'Hello'#13#10'H'#13#10'TSimpleClass'#13#10 + 'True'#13#10 +
          '3.14'#13#10 + '628'#13#10 + '100'#13#10, exec.Result.ToString,
          'result');
      finally
        prog := nil;
      end;
...
begin
  ...
  try
    ...
    try
      prog := FCompiler.Compile('PrintLn(FieldOne.Value);'#13#10 +
        'PrintLn(FieldTwo);'#13#10 + 'PrintLn(FieldOne.ClassName);');
      try
        CheckEquals('', prog.Msgs.AsInfo, 'compile');
        ...
        CheckEquals('456'#13#10'World'#13#10'TSimpleClass'#13#10,
          exec.Result.ToString, 'result 2');
        ...
        CheckEquals('123'#13#10'Hello'#13#10'TSimpleClass'#13#10,
          exec.Result.ToString, 'result 1');
      finally
        prog := nil;
      end;
    finally
  ...
  try
    ...
    try
      prog := FCompiler.Compile('FieldOne.Value:=111;'#13#10 +
        'FieldTwo:="World";'#13#10 + 'FieldBool:=False;'#13#10 +
        'FieldFloat:=4.5;'#13#10 + 'FieldInteger:=222;'#13#10 +
        'var r:=FieldRec;'#13#10 + 'r.Alpha:=2*r.Alpha;'#13#10 +
        'FieldRec:=r;'#13#10 + 'PrintLn(FieldOne.Value);'#13#10 +
        'PrintLn(FieldTwo);'#13#10 + 'PrintLn(FieldBool);'#13#10 +
        'PrintLn(FieldFloat);'#13#10 + 'PrintLn(FieldInteger);'#13#10 +
        'PrintLn(FieldRec.Alpha);'#13#10);
      try
        CheckEquals('', prog.Msgs.AsInfo, 'compile');
        ...
        CheckEquals('111'#13#10 + 'World'#13#10 + 'False'#13#10 + '4.5'#13#10 +
          '222'#13#10 + '200'#13#10, exec.Result.ToString, 'result');
      finally
        prog := nil;
      end;
    finally

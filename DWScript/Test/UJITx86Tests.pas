...
begin
  ...
  CheckEquals('addsd xmm0, xmm1'#13#10 + 'subsd xmm1, xmm2'#13#10 +
    'mulsd xmm2, xmm3'#13#10 + 'divsd xmm3, xmm4'#13#10 +
    'minsd xmm4, xmm5'#13#10 + 'maxsd xmm6, xmm7'#13#10 +
    'sqrtsd xmm7, xmm0'#13#10 + 'cvtsi2sd xmm6, ecx'#13#10, DisasmStream);
  ...
  CheckEquals('addsd xmm0, qword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00000118h]'#13#10 + 'mulsd xmm1, qword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+00022338h]'#13#10 +
    'divsd xmm2, qword ptr [00001234h]'#13#10, DisasmStream);
end;
...
begin
  ...
  CheckEquals('comisd xmm0, xmm7'#13#10 + 'comisd xmm1, qword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+00000118h]'#13#10 +
    'comisd xmm1, qword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00022338h]'#13#10 + 'comisd xmm0, qword ptr [00001234h]'#13#10,
    DisasmStream);
end;
...
begin
  ...
  CheckEquals('xorps xmm1, xmm6'#13#10 + 'xor eax, edi'#13#10 +
    'xor esi, ecx'#13#10, DisasmStream);
end;
...
begin
  ...
  CheckEquals('movsd xmm3, qword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00000118h]'#13#10 + 'movsd xmm5, qword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+00011228h]'#13#10 + 'movsd qword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+00000228h], xmm4'#13#10 + 'movsd qword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+00022448h], xmm6'#13#10 +
    'movsd xmm0, qword ptr [00012345h]'#13#10 +
    'movsd xmm1, qword ptr [esp]'#13#10 + 'movsd qword ptr [esp], xmm2'#13#10 +
    'movsd qword ptr [edx+11h], xmm3'#13#10 +
    'movsd qword ptr [ecx+00001122h], xmm4'#13#10 +
    'movsd xmm3, qword ptr [eax+22h]'#13#10 +
    'movsd xmm4, qword ptr [ecx+00000080h]'#13#10, DisasmStream);
end;
...
begin
  ...
  CheckEquals('movq qword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00000228h], xmm4'#13#10 + 'movq qword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+00022448h], xmm6'#13#10 +
    'movq xmm3, qword ptr [00000011h]'#13#10, DisasmStream);
end;
...
var
  ...
  expect: String;
begin
  for dest := gprEAX to gprEDI do
  begin
    for src := gprEAX to gprEDI do
    begin
      expect := '';
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        expect := expect + 'mov dword ptr [' + cgpRegisterName[dest];
        case offset of
          1:
            expect := expect + '+40h';
          2:
...
begin
  ...
  CheckEquals('mov eax, dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+18h]'#13#10 + 'mov edx, dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00001009h]'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+2Ah], ecx'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00022338h], ecx'#13#10, DisasmStream);
  ...
  CheckEquals('mov eax, dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+18h]'#13#10 + 'mov edx, dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+1Ch]'#13#10 + 'mov eax, dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00001008h]'#13#10 + 'mov edx, dword ptr [' + cgpRegisterName[cExecMemGPR]
    + '+0000100Ch]'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+18h], eax'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+1Ch], edx'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00001008h], eax'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR]
    + '+0000100Ch], edx'#13#10, DisasmStream);
  ...
  CheckEquals('xor eax, eax'#13#10 + 'mov dword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+08h], eax'#13#10 + 'mov dword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+0Ch], eax'#13#10 + 'mov eax, 00000001h'#13#10 +
    'xor edx, edx'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+08h], eax'#13#10 + 'mov dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+0Ch], edx'#13#10 + 'xor eax, eax'#13#10 + 'mov dword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+00001008h], eax'#13#10 + 'mov dword ptr ['
    + cgpRegisterName[cExecMemGPR] + '+0000100Ch], eax'#13#10 +
    'mov eax, FFFFFFFFh'#13#10 + 'mov dword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+00001008h], eax'#13#10 + 'mov dword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+0000100Ch], eax'#13#10 +
    'mov eax, 00000011h'#13#10 + 'xor edx, edx'#13#10 + 'mov dword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+00001008h], eax'#13#10 + 'mov dword ptr ['
    + cgpRegisterName[cExecMemGPR] + '+0000100Ch], edx'#13#10, DisasmStream);
  ...
  CheckEquals('xor eax, eax'#13#10 + 'xor edx, edx'#13#10 +
    'mov eax, 00000001h'#13#10 + 'xor edx, edx'#13#10 +
    'mov eax, FFFFFFFFh'#13#10 + 'mov edx, FFFFFFFFh'#13#10 +
    'mov eax, 22334455h'#13#10 + 'mov edx, 00000011h'#13#10 +
    'mov eax, 44556677h'#13#10 + 'mov edx, 00112233h'#13#10, DisasmStream);
end;
...
begin
  ...
  begin
    ...
    expect := 'xor ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[dest] +
      #13#10 + 'mov ' + cgpRegisterName[dest] + ', 00000001h'#13#10 + 'mov ' +
      cgpRegisterName[dest] + ', 00000080h'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
begin
  ...
  CheckEquals('add eax, 01h'#13#10 + 'adc edx, 00000000h'#13#10 +
    'add eax, 00030001h'#13#10 + 'adc edx, 02h'#13#10 + 'add eax, 33h'#13#10 +
    'adc edx, 00001122h'#13#10 + 'add dword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+08h], 01h'#13#10 + 'adc dword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+0Ch], 00000000h'#13#10 + 'add dword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+18h], 00000080h'#13#10 + 'adc dword ptr ['
    + cgpRegisterName[cExecMemGPR] + '+1Ch], 00000000h'#13#10 +
    'add dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00000808h], 00030001h'#13#10 + 'adc dword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+0000080Ch], 02h'#13#10 + 'sub dword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+08h], 01h'#13#10 + 'sbb dword ptr [' +
    cgpRegisterName[cExecMemGPR] + '+0Ch], 00000000h'#13#10 + 'sub dword ptr ['
    + cgpRegisterName[cExecMemGPR] + '+18h], 00000080h'#13#10 +
    'sbb dword ptr [' + cgpRegisterName[cExecMemGPR] + '+1Ch], 00000000h'#13#10
    + 'sub dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+00000808h], 00030001h'#13#10 + 'sbb dword ptr [' + cgpRegisterName
    [cExecMemGPR] + '+0000080Ch], 02h'#13#10, DisasmStream);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if reg <> gprEAX then
      begin
        expect := expect + 'mov eax, dword ptr [' + cgpRegisterName[reg] +
          offtextA + ']'#13#10 + 'mov edx, dword ptr [' + cgpRegisterName[reg] +
          offtextD + ']'#13#10;
      end
      else
      begin
        expect := expect + 'mov edx, dword ptr [' + cgpRegisterName[reg] +
          offtextD + ']'#13#10 + 'mov eax, dword ptr [' + cgpRegisterName[reg] +
          offtextA + ']'#13#10;
      end;
      expect := expect + 'mov dword ptr [' + cgpRegisterName[reg] + offtextA +
        '], eax'#13#10 + 'mov dword ptr [' + cgpRegisterName[reg] + offtextD +
        '], edx'#13#10;
    end;
    CheckEquals(expect, DisasmStream);
  end;
...
begin
  ...
  begin
    ...
    expect := 'add ' + cgpRegisterName[reg] + ', 01h'#13#10 + 'add ' +
      cgpRegisterName[reg] + ', 00000080h'#13#10 + 'adc ' + cgpRegisterName[reg]
      + ', 01h'#13#10 + 'adc ' + cgpRegisterName[reg] + ', 00000080h'#13#10 +
      'sub ' + cgpRegisterName[reg] + ', 01h'#13#10 + 'sub ' + cgpRegisterName
      [reg] + ', 00000080h'#13#10 + 'sbb ' + cgpRegisterName[reg] +
      ', 01h'#13#10 + 'sbb ' + cgpRegisterName[reg] + ', 00000080h'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
begin
  ...
  begin
    ...
    expect := 'add ' + cgpRegisterName[reg] + ', dword ptr [ebx+18h]'#13#10 +
      ...
      'adc ' + cgpRegisterName[reg] + ', dword ptr [ebx+18h]'#13#10 + 'adc ' +
      cgpRegisterName[reg] + ', dword ptr [ebx+00000808h]'#13#10 + 'sub ' +
      cgpRegisterName[reg] + ', dword ptr [ebx+18h]'#13#10 + 'sub ' +
      cgpRegisterName[reg] + ', dword ptr [ebx+00000808h]'#13#10 + 'sbb ' +
      cgpRegisterName[reg] + ', dword ptr [ebx+18h]'#13#10 + 'sbb ' +
      cgpRegisterName[reg] + ', dword ptr [ebx+00000808h]'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
  for reg := gprEAX to gprEDI do
  begin
...
begin
  ...
  begin
    ...
    if reg = gprEBP then
      ...
      expect := 'inc dword ptr [' + cgpRegisterName[reg] + ']'#13#10;
    expect := expect + 'inc dword ptr [' + cgpRegisterName[reg] + '+40h]'#13#10
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        expect := expect + 'add ' + cgpRegisterName[dest] + ', dword ptr [' +
          cgpRegisterName[src] + offtextA + ']'#13#10 + 'adc ' + cgpRegisterName
          [dest] + ', dword ptr [' + cgpRegisterName[src] + offtextA + ']'#13#10
          + 'sub ' + cgpRegisterName[dest] + ', dword ptr [' + cgpRegisterName
          [src] + offtextA + ']'#13#10 + 'sbb ' + cgpRegisterName[dest] +
          ', dword ptr [' + cgpRegisterName[src] + offtextA + ']'#13#10;
      end;
      CheckEquals(expect, DisasmStream);
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        expect := expect + 'and ' + cgpRegisterName[dest] + ', dword ptr [' +
          cgpRegisterName[src] + offtextA + ']'#13#10 + 'or ' + cgpRegisterName
          [dest] + ', dword ptr [' + cgpRegisterName[src] + offtextA + ']'#13#10
          + 'xor ' + cgpRegisterName[dest] + ', dword ptr [' + cgpRegisterName
          [src] + offtextA + ']'#13#10;
      end;
      CheckEquals(expect, DisasmStream);
    end;
...
begin
  ...
  begin
    ...
    expect := expect + 'neg ' + cgpRegisterName[reg] + #13#10 + 'not ' +
      cgpRegisterName[reg] + #13#10;
  end;
  CheckEquals(expect, DisasmStream);
end;
...
begin
  ...
  begin
    ...
    expect := 'shr ' + cgpRegisterName[reg] + ', cl'#13#10 + 'shr ' +
      cgpRegisterName[reg] + ', 1 '#13#10 + 'shr ' + cgpRegisterName[reg] +
      ', 7Fh'#13#10 + 'shl ' + cgpRegisterName[reg] + ', cl'#13#10 + 'shl ' +
      cgpRegisterName[reg] + ', 1 '#13#10 + 'shl ' + cgpRegisterName[reg] +
      ', 7Fh'#13#10 + 'sar ' + cgpRegisterName[reg] + ', cl'#13#10 + 'sar ' +
      cgpRegisterName[reg] + ', 1 '#13#10 + 'sar ' + cgpRegisterName[reg] +
      ', 7Fh'#13#10 + 'sal ' + cgpRegisterName[reg] + ', cl'#13#10 + 'sal ' +
      cgpRegisterName[reg] + ', 1 '#13#10 + 'sal ' + cgpRegisterName[reg] +
      ', 7Fh'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
begin
  ...
  CheckEquals('shrd eax, edx, 00000007h'#13#10 + 'shr edx, 07h'#13#10 +
    'shld edx, eax, 00000007h'#13#10 + 'shl eax, 07h'#13#10 +
    'shrd eax, edx, 00000007h'#13#10 + 'sar edx, 07h'#13#10, DisasmStream);

  FStream._shr_eaxedx_cl;
  FStream._shl_eaxedx_cl;
  FStream._sar_eaxedx_cl;

  CheckEquals('shrd eax, edx, cl'#13#10 + 'shr edx, cl'#13#10 +
    'shld edx, eax, cl'#13#10 + 'shl eax, cl'#13#10 + 'shrd eax, edx, cl'#13#10
    + 'sar edx, cl'#13#10, DisasmStream);
end;
...
begin
  ...
  begin
    ...
    expect := 'xor ' + cgpRegisterName[reg] + ', 01h'#13#10 + 'xor ' +
      cgpRegisterName[reg] + ', 00000080h'#13#10 + 'and ' + cgpRegisterName[reg]
      + ', 01h'#13#10 + 'and ' + cgpRegisterName[reg] + ', 00000080h'#13#10 +
      'or ' + cgpRegisterName[reg] + ', 01h'#13#10 + 'or ' + cgpRegisterName
      [reg] + ', 00000080h'#13#10 + 'cmp ' + cgpRegisterName[reg] +
      ', 01h'#13#10 + 'cmp ' + cgpRegisterName[reg] + ', 00000080h'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      expect := 'xor ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[src] +
        #13#10 + 'and ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[src] +
        #13#10 + 'or ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[src] +
        #13#10 + 'cmp ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[src] +
        #13#10 + 'add ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[src] +
        #13#10 + 'adc ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[src] +
        #13#10 + 'sub ' + cgpRegisterName[dest] + ', ' + cgpRegisterName[src] +
        #13#10 + 'sbb ' + cgpRegisterName[dest] + ', ' + cgpRegisterName
        [src] + #13#10;
      CheckEquals(expect, DisasmStream);
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      expect := expect + 'imul ' + cgpRegisterName[dest] + ', ' +
        cgpRegisterName[src] + #13#10;
    end;
    CheckEquals(expect, DisasmStream);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      expect := 'mul dword ptr [' + cgpRegisterName[src] + offsetText +
        ']'#13#10;
      FStream._mul_dword_ptr_reg(src, offset * $40);
      for reg := gprEAX to gprEDI do
      begin
        FStream._imul_reg_dword_ptr_reg(reg, src, offset * $40);
        expect := expect + 'imul ' + cgpRegisterName[reg] + ', dword ptr [' +
          cgpRegisterName[src] + offsetText + ']'#13#10;
      end;
      CheckEquals(expect, DisasmStream);
    end;
  end;
...
begin
  ...
  CheckEquals('fild qword ptr [' + cgpRegisterName[cExecMemGPR] + '+08h]'#13#10
    ...
    'fild qword ptr [esp]'#13#10 + 'fistp qword ptr [esp]'#13#10 +
    'fld qword ptr [esp]'#13#10 + 'fstp qword ptr [esp]'#13#10, DisasmStream);
end;
...
begin
  ...
  begin
    ...
    expect := 'push ' + cgpRegisterName[dest] + #13#10 + 'pop ' +
      cgpRegisterName[dest] + #13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
begin
  ...
  begin
    ...
    if reg = gprEBP then
      expect := expect + '+00h';
    expect := expect + ']'#13#10;
    CheckEquals(expect + 'call dword ptr [' + cgpRegisterName[reg] +
      '+40h]'#13#10 + 'call dword ptr [' + cgpRegisterName[reg] +
...
begin
  ...
  CheckEquals('cmp dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+08h], 00000000h'#13#10 + 'cmp dword ptr [' + cgpRegisterName[cExecMemGPR]
    + '+09h], 01h'#13#10 + 'cmp dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+18h], 10h'#13#10 + 'cmp dword ptr [' + cgpRegisterName[cExecMemGPR] +
    '+2Ah], 00112233h'#13#10, DisasmStream);
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        expect := expect + 'cmp dword ptr [' + cgpRegisterName[dest];
        case offset of
          1:
            expect := expect + '+40h';
          2:
...
begin
  ...
  begin
    ...
    expect := 'cmp ' + cgpRegisterName[reg] + ', 40h'#13#10 + 'cmp ' +
      cgpRegisterName[reg] + ', 00000080h'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      expect := expect + 'test ' + cgpRegisterName[dest] + ', ' +
        cgpRegisterName[src] + #13#10;
    end;
    CheckEquals(expect, DisasmStream);
  end;
...
begin
  ...
  begin
    ...
    case reg of
      gprEAX:
        expect := 'test ' + cgpRegister8bitName[reg] + ', 40h'#13#10;
      gprECX .. gprEBX:
        expect := 'test ' + cgpRegister8bitName[reg] + ', 00000040h'#13#10;
    else
...
begin
  ...
  begin
    ...
    if reg = gprEBP then
      expect := 'test dword ptr [' + cgpRegisterName[reg] +
        '+00h], 00000101h'#13#10
    else
      expect := 'test dword ptr [' + cgpRegisterName[reg] +
        '], 00000101h'#13#10;
    expect := expect + 'test dword ptr [' + cgpRegisterName[reg] +
      '+40h], 00000102h'#13#10 + 'test dword ptr [' + cgpRegisterName[reg] +
      '+00000080h], 00000103h'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
begin
  ...
  begin
    ...
    if reg = gprEBP then
      expect := 'test byte ptr [' + cgpRegisterName[reg] +
        '+00h], 00000000h'#13#10
    else
      expect := 'test byte ptr [' + cgpRegisterName[reg] + '], 00000000h'#13#10;
    expect := expect + 'test byte ptr [' + cgpRegisterName[reg] +
      '+40h], 00000001h'#13#10 + 'test byte ptr [' + cgpRegisterName[reg] +
      '+00000080h], 00000002h'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        expect := expect + 'test dword ptr [' + cgpRegisterName[dest];
        case offset of
          1:
            expect := expect + '+40h';
          2:
...
begin
  ...
  begin
    ...
    if reg = gprEBP then
      expect := 'and byte ptr [' + cgpRegisterName[reg] +
        '+00h], 00000000h'#13#10 + 'or byte ptr [' + cgpRegisterName[reg] +
        '+00h], 00000000h'#13#10
    else
      expect := 'and byte ptr [' + cgpRegisterName[reg] + '], 00000000h'#13#10 +
        'or byte ptr [' + cgpRegisterName[reg] + '], 00000000h'#13#10;
    expect := expect + 'and byte ptr [' + cgpRegisterName[reg] +
      '+40h], 00000001h'#13#10 + 'or byte ptr [' + cgpRegisterName[reg] +
      '+40h], 00000001h'#13#10 + 'and byte ptr [' + cgpRegisterName[reg] +
      '+00000080h], 00000002h'#13#10 + 'or byte ptr [' + cgpRegisterName[reg] +
      '+00000080h], 00000002h'#13#10;
    CheckEquals(expect, DisasmStream);
  end;
end;
...
var
  ...
  expect: String;
begin
  for dest := xmm0 to xmm7 do
  begin
    for base := gprEAX to gprEDI do
    begin
      for index := gprEAX to gprEDI do
      begin
        if index = gprESP then
          continue;
        expect := '';
        for offset := 0 to 2 do
        begin
    ...
    begin
      ...
      begin
        ...
        begin
          for scale := 0 to 3 do
          begin
            FStream._mov_reg_dword_ptr_indexed(dest, base, index, 1 shl scale,
              offset * $40);
            expect := expect + 'mov ' + cgpRegisterName[dest] + ', dword ptr ['
              + cgpRegisterName[base] + '+' + cgpRegisterName[index];
            case scale of
              1:
                expect := expect + '*2';
              2:

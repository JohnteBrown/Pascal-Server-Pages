...
begin
  ...
  FJSCompiler.Config.CompilerOptions := [coVariablesAsVarOnly, coAllowClosures,
    coOptimize, coSymbolDictionary, coContextMap];
  ...
  FJSCodeGen.Options := [cgoNoRangeChecks, cgoNoCheckInstantiated,
    cgoNoCheckLoopStep, cgoNoConditions, cgoSmartLink];
...
// DoInclude
//
procedure TJSSmartLinkerTests.DoInclude(const scriptName: string;
...
// DoNeedUnit
//
function TJSSmartLinkerTests.DoNeedUnit(const unitName: String;
...
var
  ...
  prog: IdwsProgram;
begin
  prog := FJSCompiler.Compile('type TClass1 = class'#13#10 + 'c1:string;'#13#10
    + 'end;'#13#10 + 'type TClass2 = class'#13#10 + 'c2:string;'#13#10 +
    'end;'#13#10 + 'var A : TClass1;'#13#10);
...
var
  ...
  prog: IdwsProgram;
begin
  prog := FJSCompiler.Compile('type TRec = record'#13#10 + 'x:Integer;'#13#10 +
    'end;'#13#10 + 'type TAlias = TRec;'#13#10 + 'var A, B : TAlias;'#13#10 +
    'a:=B;'#13#10);
  CheckEquals(0, prog.Msgs.Count, prog.Msgs.AsInfo);
...
begin
  prog := FJSCompiler.Compile('type TRec = record'#13#10 + 'x:Integer;'#13#10 +
    'procedure Test; begin end;'#13#10 + 'end;'#13#10 +
    'procedure Bogus(p : TRec);'#13#10 + 'var r : TRec;'#13#10 +
    'begin end'#13#10);
  CheckEquals
    ('Hint: Variable "r" declared but not used [line: 6, column: 5]'#13#10,
    prog.Msgs.AsInfo);
...
var
  ...
  prog: IdwsProgram;
begin
  prog := FJSCompiler.Compile('procedure Marker(i : Integer); begin  end;'#10 +
    ...
    'field := procedure begin Test1 end;'#10 + 'end;'#10 +
    'var b : Variant := class'#10 + 'field := procedure begin Test3 end;'#10 +
    'end;'#10);

...
type
  ...
  private
    ...
    function GetUnitTable(systemTable: TSystemSymbolTable;
      unitSyms: TUnitMainSymbols; operators: TOperators;
  ...
  public
    ...
    function Compile(const text: String; const mainFileName: String = '')
      : IdwsProgram; overload;
    procedure RecompileInContext(const prog: IdwsProgram;
  ...
  published
    ...
    property OnNeedUnit: TdwsOnNeedUnitEvent read GetOnNeedUnit
      write SetOnNeedUnit stored False;
    property OnNeedUnitEx: TdwsOnNeedUnitEventEx read GetOnNeedUnitEx
      write SetOnNeedUnitEx stored False;
    property OnInclude: TIncludeEvent read GetOnInclude write SetOnInclude
      stored False;
    property OnIncludeEx: TdwsIncludeEventEx read GetOnIncludeEx
      write SetOnIncludeEx stored False;
    property OnResource: TdwsResourceEvent read GetOnResource
      write SetOnResource;
    property OnExecutionStarted: TdwsExecutionEvent read GetOnExecutionStarted
      write SetOnExecutionStarted;
    property OnExecutionEnded: TdwsExecutionEvent read GetOnExecutionEnded
      write SetOnExecutionEnded;
    property Version: String read GetVersion write SetVersion stored False;
  end;

  TLocalizeSymbolEvent = procedure(Sender: TObject;
    aResSymbol: TResourceStringSymbol; var result: String) of object;
  TLocalizeStringEvent = procedure(Sender: TObject; const aString: String;
    var result: String) of object;
  TGetLocalizerEvent = procedure(Sender: TObject; var localizer: IdwsLocalizer)
    of object;
  ...
  public
    ...
    property OnLocalizeSymbol: TLocalizeSymbolEvent read FOnLocalizeSymbol
      write FOnLocalizeSymbol;
    property OnLocalizeString: TLocalizeStringEvent read FOnLocalizeString
      write FOnLocalizeString;
  end;
  ...
  protected
    ...
    function GetUnitTable(systemTable: TSystemSymbolTable;
      unitSyms: TUnitMainSymbols; operators: TOperators;
      rootTable: TSymbolTable): TUnitSymbolTable; virtual; abstract;
    function GetUnitFlags: TIdwsUnitFlags;
    function GetDeprecatedMessage: String;
...
{$WARNINGS ON}
  ...
  protected
    function GetUnitTable(systemTable: TSystemSymbolTable;
      unitSyms: TUnitMainSymbols; operators: TOperators;
      rootTable: TSymbolTable): TUnitSymbolTable; override;
    function CreateUnitTable(parent, rootTable: TSymbolTable;
      tableType: TSymbolTableType): TUnitSymbolTable; virtual;
    procedure SetStaticSymbols(const Value: Boolean); // static symbols
    procedure InitUnitTable(systemTable: TSystemSymbolTable;
      unitSyms: TUnitMainSymbols; operators: TOperators;
      UnitTable: TUnitSymbolTable); virtual;
    procedure AddUnitSymbols(systemTable: TSystemSymbolTable;
      table: TSymbolTable; operators: TOperators); virtual; abstract;
  ...
  public
    ...
    function InitStaticSymbols(systemTable: TSystemSymbolTable;
  ...
  protected
    ...
    procedure CheckName(aTable: TSymbolTable; const aName: String;
      overloaded: Boolean = False);
    function GetDataType(systemTable: TSystemSymbolTable; aTable: TSymbolTable;
      const aName: String): TTypeSymbol;
    procedure Reset;
  ...
  public
    ...
    function Generate(systemTable: TSystemSymbolTable; table: TSymbolTable;
      parentSym: TSymbol = nil): TSymbol;
    function DoGenerate(systemTable: TSystemSymbolTable; table: TSymbolTable;
      parentSym: TSymbol = nil): TSymbol; virtual; abstract;
  ...
  published
    property IsVarParam: Boolean read FIsVarParam write SetIsVarParam
      default False;
    property IsWritable: Boolean read FIsWritable write SetIsWritable
      default True;
    property HasDefaultValue: Boolean read FHasDefaultValue
      write SetHasDefaultValue default False;
  ...
  public
    ...
    function DoGenerate(systemTable: TSystemSymbolTable; table: TSymbolTable;
      parentSym: TSymbol = nil): TSymbol; override;
    function GetParameters(systemTable: TSystemSymbolTable; table: TSymbolTable)
      : TParamArray;
    function GetNamePath: String; override;

  published
    property Parameters: TdwsParameters read FParameters write SetParameters
      stored StoreParameters;
    property ResultType: TDataType read FResultType write SetResultType;
    property OnInitSymbol: TInitSymbolEvent read GetOnInitSymbol
      write SetOnInitSymbol;
  ...
  public
    ...
    function Add(const Name: String; const ResultType: String = '')
      : TdwsFunction; overload;
  end;
  ...
  published
    property Visibility: TdwsVisibility read FVisibility write FVisibility
      default cvPublic;
    property DefaultValue: Variant read FDefaultValue write SetDefaultValue
      stored GetHasDefaultValue;
    property HasDefaultValue: Boolean read FHasDefaultValue
      write FHasDefaultValue default False;
  end;
  ...
  TAssignExternalObjectEvent = procedure(info: TProgramInfo;
    var ExtObject: TObject) of object;
  TMethodEvalEvent = procedure(info: TProgramInfo; ExtObject: TObject)
    of object;
  ...
  published
    property Attributes: TMethodAttributes read FAttributes write SetAttributes
      default [];
    property Visibility: TdwsVisibility read FVisibility write FVisibility
      default cvPublic;
    ...
    property OnFastEval: TMethodFastEvalEvent read FOnFastEval
      write FOnFastEval;
    property OnFastEvalNoResult: TMethodFastEvalNoResultEvent
      read FOnFastEvalNoResult write FOnFastEvalNoResult;
    property OnFastEvalString: TMethodFastEvalStringEvent read FOnFastEvalString
      write FOnFastEvalString;
    property OnFastEvalInteger: TMethodFastEvalIntegerEvent
      read FOnFastEvalInteger write FOnFastEvalInteger;
    property OnFastEvalFloat: TMethodFastEvalFloatEvent read FOnFastEvalFloat
      write FOnFastEvalFloat;
    property OnFastEvalBoolean: TMethodFastEvalBooleanEvent
      read FOnFastEvalBoolean write FOnFastEvalBoolean;
    property OnFastEvalScriptObj: TMethodFastEvalScriptObjEvent
      read FOnFastEvalScriptObj write FOnFastEvalScriptObj;
  end;
  ...
  published
    ...
    property IsInternal: Boolean read FIsInternal write FIsInternal
      default False;
    property Deprecated: String read FDeprecated write FDeprecated;
    property Constructors: TdwsConstructors read FConstructors
      write FConstructors stored StoreConstructors;
  ...
  published
    property UserDefValue: Int64 read FUserDefValue write SetUserDefValue
      default 0;
  ...
  published
    ...
    property Style: TEnumerationSymbolStyle read FStyle write FStyle
      default enumClassic;
  end;
  ...
  TWriteVarEvent = procedure(info: TProgramInfo; const Value: Variant)
    of object;
  TInstantiateEvent = procedure(info: TProgramInfo; var ExtObject: TObject)
    of object;
  ...
  protected
    ...
    procedure DoInstantiate(info: TProgramInfo;
      var ExternalObject: TObject); virtual;
  ...
  public
    ...
    property OnObjectDestroy: TObjectDestroyEvent read FOnObjectDestroy
      write FOnObjectDestroy;
    property OnInstantiate: TInstantiateEvent read FOnInstantiate
      write FOnInstantiate;
    property OnInitSymbol: TInitSymbolEvent read FOnInitSymbol
      write FOnInitSymbol;
    property OnInitExpr: TInitExprEvent read FOnInitExpr write FOnInitExpr;
  end;
  ...
  protected
    ...
    function InternalTypeDefined(const Name: String;
      visited: TStringList): Boolean;

  protected
    function GetSymbol(systemTable: TSystemSymbolTable; table: TSymbolTable;
    ...
    procedure InitUnitTable(systemTable: TSystemSymbolTable;
      unitSyms: TUnitMainSymbols; operators: TOperators;
      UnitTable: TUnitSymbolTable); override;
  ...
  public
    ...
    procedure ExposeClassToUnit(AClass, AAncestor: TClass;
      ASearchProgram: TdwsProgram = nil; const ScriptAncestorType: String = '');
    procedure ExposeInstanceToUnit(const aName, AClassType: String;
      AInstance: TObject);
  ...
  published
    ...
    property Enumerations: TdwsEnumerations read FEnumerations
      write SetEnumerations stored StoreEnumerations;
    property Sets: TdwsSets read FSets write SetSets stored StoreSets;
    property Forwards: TdwsForwards read FForwards write SetForwards
      stored StoreForwards;
    property Functions: TdwsFunctions read FFunctions write SetFunctions
      stored StoreFunctions;
    property Delegates: TdwsDelegates read FDelegates write SetDelegates
      stored StoreDelegates;
    property Instances: TdwsInstances read FInstances write SetInstances
      stored StoreInstances;
    property operators: TdwsOperators read FOperators write SetOperators
      stored StoreOperators;
    property Records: TdwsRecords read FRecords write SetRecords
      stored StoreRecords;
    property Interfaces: TdwsInterfaces read FInterfaces write SetInterfaces
      stored StoreInterfaces;
    property Synonyms: TdwsSynonyms read FSynonyms write SetSynonyms
      stored StoreSynonyms;
    property ParseName: TdwsParseName read FParseName write FParseName
      default pnAtDesignTimeOnly;
    property UnitName;
    ...
    property Variables: TdwsVariables read FVariables write SetVariables
      stored StoreVariables;
    property StaticSymbols;

    property OnAfterInitUnitTable: TNotifyEvent read FOnAfterInitUnitTable
      write FOnAfterInitUnitTable;
  end;
  ...
  public
    ...
    procedure InitSymbol(symbol: TSymbol;
      const msgs: TdwsCompileMessageList); override;
  ...
  private
    ...
    FSize: Integer;
  public
    procedure DoEval(const args: TExprBaseListExec;
  ...
  private
    FOnFastEval: TMethodFastEvalEvent;
  public
    procedure DoEvalAsVariant(baseExpr: TTypedExpr;
      const args: TExprBaseListExec; var result: Variant);
  end;
...
function GetExternalObjForID(info: TProgramInfo;
  const AVarName: String): TObject;
...
// DoEvalProc
//
procedure TCustomInternalMagicProcedure.DoEvalProc
  (const args: TExprBaseListExec);
begin
  FOnFastEval(args);
end;
...
// DoEvalAsVariant
//
procedure TCustomInternalMagicFunction.DoEvalAsVariant
  (const args: TExprBaseListExec; var result: Variant);
begin
...
// DoEval
//
procedure TCustomInternalMagicDataFunction.DoEval(const args: TExprBaseListExec;
...
// DoEvalAsVariant
//
procedure TCustomInternalMagicMethod.DoEvalAsVariant(baseExpr: TTypedExpr;
  const args: TExprBaseListExec; var result: Variant);
begin
...
begin
  ...
  begin
    ...
    raise EdwsActivePrograms.CreateFmt
      ('TDelphiWebScript instance "%s" still has %d active IdwsProgram instance(s)',
      [Name, n]);
  end;
...
// Compile
//
function TDelphiWebScript.Compile(const text: String;
...
// RecompileInContext
//
procedure TDelphiWebScript.RecompileInContext(const prog: IdwsProgram;
  const text: String);
begin
  Lock;
  try
...
begin
  ...
  for y := 0 to FClasses.Count - 1 do
  begin
  ...
  for y := 0 to aCollection.Count - 1 do
  begin
    collSym := TdwsSymbol(aCollection.Items[y]);
    if not collSym.IsGenerating then
    begin
      try
...
procedure TdwsUnit.AddUnitSymbols(systemTable: TSystemSymbolTable;
...
function TdwsUnit.GetSymbol(systemTable: TSystemSymbolTable;
  table: TSymbolTable; const Name: String): TSymbol;

  procedure RaiseCircularReference(item: TdwsSymbol);
  begin
    raise Exception.CreateFmt(UNT_CircularReference,
      [item.ClassName + ':' + Name]);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      item := coll.Items[y];
      if UnicodeSameText(item.Name, Name) then
      begin
...
function TdwsUnit.InternalTypeDefined(const Name: String;
  visited: TStringList): Boolean;
var
  dep: String;
  depIdx: Integer;
...
begin
  ...
  begin
    ...
    if depIdx > -1 then
      result := TdwsUnit(FScript.FConfig.Units.Items[depIdx])
        .InternalTypeDefined(name, visited);
    if result then
      Exit;
  end;
end;
...
procedure TdwsUnit.HandleDynamicProperty(info: TProgramInfo;
  ExtObject: TObject);
var
  propName: String;
  param: TParamSymbol;
...
begin
  ...
  begin
    propName := StrDeleteLeft(info.FuncSym.Name, 3);
    // get property name. Trim off Get/Set prefix
    case TMethodSymbol(info.FuncSym).Kind of
      fkFunction: // function is a "Get" method
        begin
          ...
          // Class
          if info.FuncSym.Typ.IsClassSymbol then
          // don't free the object instance returned
            info.ResultAsVariant := info.RegisterExternalObject
              (GetObjectProp(ExtObject, propName), False, False)
            // wrap as best we can (find a match)
            // Boolean
        ...
        begin
          ...
          begin
            ...
            if param.Typ.IsClassSymbol then
              SetObjectProp(ExtObject, propName,
                info.GetExternalObjForVar(param.Name))
              // Boolean
...
procedure TdwsUnit.ExposeClassToUnit(AClass, AAncestor: TClass;
  ASearchProgram: TdwsProgram; const ScriptAncestorType: String);
    ...
    begin
      ...
      begin
        if ASearchProgram.table.Symbols[x].ClassType = TUnitSymbol then
          ...
          if TUnitSymbol(ASearchProgram.table.Symbols[x])
            .table.FindLocal(ATypeName) <> nil then
          begin
            result := True;
            // add the declaring unit as a dependency
            if Self.Dependencies.IndexOf(ASearchProgram.table.Symbols[x].Name) < 0
            then
...
{$ENDIF}
      ...
      begin
        ...
        case PropList^[i]^.PropType^.Kind of
          tkInteger:
            PropertyType := SYS_INTEGER;
          tkFloat:
            PropertyType := SYS_FLOAT;
          tkString, tkLString, tkWString:
            PropertyType := SYS_STRING;
          tkVariant:
            PropertyType := SYS_VARIANT;
          tkEnumeration:
          // Booleans are reported as enumerations. Only support booleans
            begin
{$IFDEF FPC}
...
procedure TdwsUnit.InitUnitTable(systemTable: TSystemSymbolTable;
  unitSyms: TUnitMainSymbols; operators: TOperators;
...
procedure TdwsUnit.HandleDynamicCreate(info: TProgramInfo;
  var ExtObject: TObject);
begin
  { TODO : If accepted, create a String declaration in appropriate unit. }
  raise Exception.CreateFmt
    ('Cannot create dynamic class "%s". Must be obtained from supported objects.',
    [info.ScriptObj.GetClassSym.Name]);
end;
...
// DoGenerate
//
function TdwsConstant.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol): TSymbol;
begin
  FIsGenerating := True;
  CheckName(table, Name);

  result := TConstSymbol.CreateValue(Name, GetDataType(systemTable, table,
    DataType), Value);
...
function TdwsGlobal.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
  typSym: TTypeSymbol;
...
begin
  ...
  if typSym is TArraySymbol then
    raise EHandledGenerationError.CreateFmt
      ('Globals of array type not supported: %s in %s', [Name, FUnit.Name]);
  if typSym is TRecordSymbol then
    raise EHandledGenerationError.CreateFmt
      ('Globals of record type not supported: %s in %s', [Name, FUnit.Name]);
...
// Call
//
procedure TDynamicInstantiateFunc.Call(exec: TdwsProgramExecution;
  func: TFuncSymbol);
var
  v: Variant;
...
function TdwsParameter.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
begin
  result := nil;
    ...
    begin
      case tok.TestAny([ttStrVal, ttIntVal, ttFloatVal]) of
        ...
        begin
          ...
          raise Exception.Create('Default value expected');
      end;
    end;
...
// Specialize
//
function TdwsCallable.Specialize(const context: ISpecializationContext)
  : IExecutable;
begin
...
// CompileTimeCheck
//
procedure TdwsCallable.CompileTimeCheck(context: TdwsCompilerContext;
  expr: TFuncExprBase);
begin
  // nothing yet
end;
...
// Call
//
procedure TdwsFunctionCallable.Call(exec: TdwsProgramExecution;
  func: TFuncSymbol);
var
  info: TProgramInfo;
begin
...
// DoGenerate
//
function TdwsFunctionSymbol.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
  FuncSym: TFuncSymbol;
begin
  ...
  FuncSym := TFuncSymbol.Generate(table, Name, GetParameters(systemTable,
    table), ResultType);
  try
...
begin
  ...
  begin
    ...
    begin
      ...
      if paramSym is TEnumerationSymbol then
      begin
        ...
        if elemSym = nil then
          ...
          elemValue := TElementSymbol(elemSym).Value;
        paramRec.DefaultValue.AsInteger[0] := elemValue;
      end
      else if paramSym.IsPointerType and VarIsNull(param.DefaultValue) then
        paramRec.DefaultValue.AsInterface[0] := IUnknown(nil)
      else
        paramRec.DefaultValue[0] := param.DefaultValue;
    end
    else
      paramRec.DefaultValue := nil;

    symbol.GetUnit.GetSymbol(systemTable, table, paramRec.ParamType);
  end;
end;

function TdwsFunctionSymbol.GetParameters(systemTable: TSystemSymbolTable;
  table: TSymbolTable): TParamArray;
begin
...
begin
  raise Exception.Create
    ('Only methods of a class can be constructors or destructors');
end;
...
begin
  ...
  try
    ...
    methodType := tok.TestDeleteAny([ttFUNCTION, ttPROCEDURE, ttMETHOD,
      ...
      begin
        ...
        begin
          if Length(Params) > 1 then
            raise Exception.Create
              ('Default value not allowed for a list of more than 1 parameter');
          case tok.TestAny([ttStrVal, ttIntVal, ttFloatVal]) of
            ttStrVal:
              begin
...
// DoGenerate
//
function TdwsFunction.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
...
begin
  ...
  if ResultType = '' then
  begin
    func := TCustomInternalMagicProcedure.Create(table, Name,
      GetParameters(systemTable, table), ResultType, flags, nil, '', '');
  ...
  begin
    ...
    begin
      func := TCustomInternalMagicDataFunction.Create(table, Name,
        GetParameters(systemTable, table), ResultType, flags, nil, '', '');
    ...
    begin
      func := TCustomInternalMagicFunction.Create(table, Name,
        GetParameters(systemTable, table), ResultType, flags, nil, '', '');
...
function TdwsField.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
  data: TData;
begin
  ...
  result := TFieldSymbol.Create(Name, GetDataType(systemTable, table, DataType),
    Visibility);
  if FHasDefaultValue then
  begin
    SetLength(data, 1);
...
begin
  result := TClassSymbol.VisibilityToString(Visibility) + ' ' +
...
// Call
//
procedure TdwsMethodCallable.Call(exec: TdwsProgramExecution;
  func: TFuncSymbol);
var
  info: TProgramInfo;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        raise Exception.Create(RTE_ObjectNotInstantiated);
    finally
      exec.ReleaseProgramInfo(info);
    end;
  end;
...
// DoGenerate
//
function TdwsMethod.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
...
begin
  ...
  if Assigned(FOnFastEval) or Assigned(FOnFastEvalNoResult) or
    Assigned(FOnFastEvalString) or Assigned(FOnFastEvalInteger) or
    Assigned(FOnFastEvalFloat) or Assigned(FOnFastEvalBoolean) or
    Assigned(FOnFastEvalScriptObj) then
  begin
    ...
    methSymbol := TMagicMethodSymbol.Generate(table, Kind, Attributes, Name,
      GetParameters(systemTable, table), ResultType, TClassSymbol(parentSym),
...
// Call
//
procedure TdwsConstructorCallable.Call(exec: TdwsProgramExecution;
  func: TFuncSymbol);
var
  info: TProgramInfo;
  extObj: TObject;
begin
  ...
  try
    ...
    begin
      if Assigned(info.ScriptObj) then
      begin
        extObj := info.ScriptObj.ExternalObject;
        // may assigned by Info.GetConstructor()
        try
          FOnEval(info, extObj);
        finally
...
// DoGenerate
//
function TdwsConstructor.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol): TSymbol;
var
  methSymbol: TMethodSymbol;
begin
  ...
  methSymbol := TMethodSymbol.Generate(table, mkConstructor, Attributes, Name,
    GetParameters(systemTable, table), '', TClassSymbol(parentSym), Visibility,
    overloaded);
  try
    methSymbol.Params.AddParent(table);
    methSymbol.Executable := FCallable;
...
begin
  ...
  result := TClassSymbol.VisibilityToString(Visibility) +
    Format(' constructor %s%s;', [Name, result]);
end;
...
// DoGenerate
//
function TdwsClassConstant.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
begin
  FIsGenerating := True;
  CheckName(table, Name);

  result := TClassConstSymbol.CreateValue(Name, GetDataType(systemTable, table,
    DataType), Value);
...
// DoGenerate
//
function TdwsClass.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
  x: Integer;
  sym: TSymbol;
...
begin
  ...
  try
    ...
    ancestorSym := TClassSymbol(GetUnit.GetSymbol(systemTable, table,
      FAncestor));
    ...
    for x := 0 to FFields.Count - 1 do
      ClassSym.AddField(TFieldSymbol(TdwsField(FFields.Items[x])
        .Generate(systemTable, table, ClassSym)));

    for x := 0 to FConstructors.Count - 1 do
      ClassSym.AddMethod(TMethodSymbol(TdwsConstructor(FConstructors.Items[x])
        .Generate(systemTable, table, ClassSym)));

    for x := 0 to FMethods.Count - 1 do
      ClassSym.AddMethod(TMethodSymbol(TdwsMethod(FMethods.Items[x])
        .Generate(systemTable, table, ClassSym)));

    for x := 0 to FProperties.Count - 1 do
      ClassSym.AddProperty(TPropertySymbol(TdwsProperty(FProperties.Items[x])
        .Generate(systemTable, table, ClassSym)));

    for x := 0 to FOperators.Count - 1 do
      ClassSym.AddOperator
        (TClassOperatorSymbol(TdwsClassOperator(FOperators.Items[x])
        .Generate(systemTable, table, ClassSym)));

    for x := 0 to FConstants.Count - 1 do
      ClassSym.AddConst(TClassConstSymbol(TdwsConstant(FConstants.Items[x])
        .Generate(systemTable, table, ClassSym)));
...
function TdwsMember.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
begin
  FIsGenerating := True;
  CheckName(TRecordSymbol(parentSym).Members, Name);
  var
  fieldType := GetDataType(systemTable, table, DataType);
  var
  fieldSym := TFieldSymbol.Create(Name, fieldType, Visibility);
...
begin
  ...
  try
    for x := 0 to FMembers.Count - 1 do
      TRecordSymbol(result)
        .AddField(TFieldSymbol(TdwsMember(FMembers.Items[x])
        .Generate(systemTable, table, result)));
    for x := 0 to FProperties.Count - 1 do
      TRecordSymbol(result).AddProperty
        (TPropertySymbol(TdwsProperty(FProperties.Items[x])
        .Generate(systemTable, table, result)));
    GetUnit.table.AddSymbol(result);
  except
    result.Free;
...
begin
  inherited;
  if Source is TdwsInterface then
  begin
...
// DoGenerate
//
function TdwsInterface.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
  x: Integer;
...
begin
  ...
  try
    ...
    for x := 0 to FMethods.Count - 1 do
      intfSym.AddMethod(TMethodSymbol(TdwsMethod(FMethods.Items[x])
        .Generate(systemTable, table, intfSym)));

    for x := 0 to FProperties.Count - 1 do
      intfSym.AddProperty(TPropertySymbol(TdwsProperty(FProperties.Items[x])
        .Generate(systemTable, table, intfSym)));
  except
    if not intfSym.IsForwarded then
      intfSym.Free;
...
function TdwsArray.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
begin
  FIsGenerating := True;
  CheckName(table, Name);
  if (LowBound = 0) and (HighBound = -1) then
    result := TDynamicArraySymbol.Create(Name, GetDataType(systemTable, table,
      DataType), systemTable.TypInteger)
  else
  begin
    if LowBound > HighBound then
      raise Exception.Create(UNT_InvalidArrayBounds);
    result := TStaticArraySymbol.Create(Name, GetDataType(systemTable, table,
      DataType), systemTable.TypInteger, LowBound, HighBound);
  end;
  GetUnit.table.AddSymbol(result);
end;
...
// DoGenerate
//
function TdwsProperty.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
...
begin
  ...
  var
    propertyTypSym: TTypeSymbol;
  var
    promotionFrom: TPropertySymbol := nil;

    // Visibility promotion ?
  if (FName <> '') and (FReadAccess = '') and (FWriteAccess = '') and
    (DataType = '') and (IndexType = '') then
  begin

    var
    sym := parent.Members.FindSymbolFromScope(FName, parent);
  ...
  begin
    ...
    if DataType = '' then
      raise Exception.CreateFmt(UNT_DatatypeNotSpecified,
        [Name, parentSym.Name]);
  ...
  var
  propSym := TPropertySymbol.Create(Name, propertyTypSym, Visibility, nil);
  result := propSym;

  propSym.GenerateParams(table, GetParameters(Self, Parameters,
    systemTable, table));

  if promotionFrom <> nil then
  begin
...
begin
  ...
  begin
    ...
    if FIsDefault then
    begin
      Properties := GetProperties(TdwsCollection(Collection).GetOwner);
      // GetOwner can return a TdwsClass as well as a TdwsInterface, so GetProperties is used to distinguish.
...
begin
  ...
  try
    ...
    begin
      ...
      raise Exception.Create('Property name expected');
    ...
    begin
      ...
      begin
        ...
        raise Exception.Create('ReadAccess expected');
    end;
    ...
    begin
      ...
      begin
        ...
        raise Exception.Create('WriteAccess expected');
    end;
...
function TdwsClassOperator.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
...
begin
  ...
  begin
    sym := Members[i];
    if UnicodeSameText(sym.Name, FUsesAccess) and (sym is TMethodSymbol) then
    begin
      foundNameMatch := True;
      if (TMethodSymbol(sym).Params.Count = 1) and
        (TMethodSymbol(sym).Params[0].Typ = result.Typ) then
      begin
...
begin
  result := Format('operator %s %s uses %s;', [cTokenStrings[FOperator],
    DataType, UsesAccess])
end;
...
// Generate
//
function TdwsSymbol.Generate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
begin
  try
    ...
    on e: EHandledGenerationError do
      raise;
    on e: Exception do
      raise Exception.CreateFmt(UNT_SymbolGenerationError,
...
// GetDataType
//
function TdwsSymbol.GetDataType(systemTable: TSystemSymbolTable;
  aTable: TSymbolTable; const aName: String): TTypeSymbol;
var
  sym: TSymbol;
begin
...
constructor TWriteVarFunc.Create(FuncSym: TFuncSymbol;
  ReadVarFunc: TReadVarFunc);
begin
...
begin
  FReadVarFunc.SetValue(info.Execution.Stack.data,
    info.Execution.Stack.StackPointer - 1);
end;
...
begin
  ...
  begin
    ...
    raise EdwsInvalidUnitAddition.Create
      ('Do not use AddUnit method but Script property instead');
  end;
end;
...
begin
  if not(csDesigning in ComponentState) and Assigned(FScript) and
    not UnicodeSameText(Value, FUnitName) then
...
function TdwsEmptyUnit.GetUnitTable(systemTable: TSystemSymbolTable;
  unitSyms: TUnitMainSymbols; operators: TOperators; rootTable: TSymbolTable)
  : TUnitSymbolTable;
var
  x: Integer;
  sym: TUnitMainSymbol;
...
// DoGenerate
//
function TdwsEnumeration.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol): TSymbol;
var
  i: Integer;
...
begin
  ...
  try
    ...
    begin
      element := (Elements.Items[i] as TdwsElement).Generate(systemTable, table,
        enumSymbol) as TElementSymbol;
      enumSymbol.AddElement(element);
      if Style = enumClassic then
      begin
      ...
      if tok.TestDelete(ttBLEFT) then
        repeat
          ...
          begin
            ...
            raise Exception.Create('Element name expected');
...
function TdwsElement.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol): TSymbol;
var
  enumInt: Int64;
...
begin
  ...
  else if enumSym.Style = enumFlags then
  begin
    if enumSym.Elements.Count > 0 then
      enumInt := TElementSymbol(enumSym.Elements[enumSym.Elements.Count - 1]
        ).Value * 2
    else
      enumInt := 1;
  end
...
begin
  ...
  begin
    ...
    FAutoDestroyExternalObject := TdwsCustomInstance(Source)
      .AutoDestroyExternalObject;
  end;
end;
...
function TdwsCustomInstance.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol): TSymbol;
var
  typSym: TTypeSymbol;
...
procedure TdwsCustomInstance.DoInstantiate(info: TProgramInfo;
...
// Add
//
function TdwsFunctions.Add(const Name: String; const ResultType: String = '')
  : TdwsFunction;
begin
  result := Add;
...
// DoGenerate
//
function TdwsSet.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;
var
  base: TTypeSymbol;
    ...
    begin
      ...
      begin
        if tok.TestName then
          ...
          raise Exception.Create('Base type name expected');
      end
      else
        raise Exception.Create('"set of" expected');
    end;
  finally
    sourceFile.Free;
    tok.Free;
...
// Add
//
function TdwsMethods.Add(const Name: String; const ResultType: String = '')
  : TdwsMethod;
begin
  result := Add;
  result.Name := name;
...
function TdwsSynonym.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol): TSymbol;
begin
  FIsGenerating := True;
  CheckName(table, Name);
  result := TAliasSymbol.Create(Name, GetDataType(systemTable, table,
    DataType));
  GetUnit.table.AddSymbol(result);
end;
...
function TdwsAbstractStaticUnit.CreateUnitTable(parent, rootTable: TSymbolTable;
  tableType: TSymbolTableType): TUnitSymbolTable;
begin
  case tableType of
    sttLinked:
    ...
    if rootTable = nil then
      ...
      result := TUnitSymbolTable.Create(parent, rootTable.AddrGenerator);
  end;
end;
...
function TdwsAbstractStaticUnit.GetUnitTable(systemTable: TSystemSymbolTable;
  unitSyms: TUnitMainSymbols; operators: TOperators; rootTable: TSymbolTable)
  : TUnitSymbolTable;
begin
  if StaticSymbols and InitStaticSymbols(systemTable, unitSyms, operators) then
    result := CreateUnitTable(FStaticTable.SymbolTable, nil, sttLinked)
      as TLinkedSymbolTable // typecheck
  else
  begin
...
function TdwsAbstractStaticUnit.InitStaticSymbols
  (systemTable: TSystemSymbolTable; unitSyms: TUnitMainSymbols;
...
begin
  ...
  begin
    ...
    begin
      FStaticTable := CreateUnitTable(staticParent, nil, sttStatic)
        as TStaticSymbolTable;
      try
        InitUnitTable(systemTable, unitSyms, operators,
          FStaticTable.SymbolTable);
      except
        ReleaseStaticSymbols;
        raise;
      end;
...
procedure TdwsAbstractStaticUnit.InitUnitTable(systemTable: TSystemSymbolTable;
  unitSyms: TUnitMainSymbols; operators: TOperators;
  UnitTable: TUnitSymbolTable);
var
  x: Integer;
...
// Notification
//
procedure TdwsCustomLangageExtension.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited;
  if (Operation = opRemove) and (AComponent = FScript) then
...
begin
  if Source is TdwsTypeSymbol then
  begin
...
begin
  if Source is TdwsOperator then
  begin
...
// DoGenerate
//
function TdwsOperator.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol = nil): TSymbol;

  procedure RaiseError;
  begin
    raise EGenerationError.CreateFmt(UNT_IncorrectOperatorOverload,
      [DisplayName]);
  end;
...
// LocalizeSymbol
//
procedure TEventBasedLocalizer.LocalizeSymbol(aResSymbol: TResourceStringSymbol;
  var result: String);
begin
...
// LocalizeString
//
procedure TEventBasedLocalizer.LocalizeString(const aString: String;
  var result: String);
begin
...
// DoGenerate
//
function TdwsDelegate.DoGenerate(systemTable: TSystemSymbolTable;
  table: TSymbolTable; parentSym: TSymbol): TSymbol;
var
  FuncSym: TFuncSymbol;
  funcKind: TFuncKind;
...
function TdwsDelegate.GetParameters(systemTable: TSystemSymbolTable;
  table: TSymbolTable): TParamArray;
begin
  result := dwsComp.GetParameters(Self, Parameters, systemTable, table);
end;
...
// Specialize
//
function TCustomInstantiateFunc.Specialize(const context
  : ISpecializationContext): IExecutable;
begin

...
function CryptAcquireContextA(phProv: PHCRYPTPROV; pszContainer: PAnsiChar;
  pszProvider: PAnsiChar; dwProvType: DWORD; dwFlags: DWORD): BOOL; stdcall;

function CryptAcquireContext(phProv: PHCRYPTPROV; pszContainer: LPAWSTR;
  pszProvider: LPAWSTR; dwProvType: DWORD; dwFlags: DWORD): BOOL; stdcall;

function CryptAcquireContextW(phProv: PHCRYPTPROV; pszContainer: PWideChar;
...
function CryptSignHashA(hHash: HCRYPTHASH; dwKeySpec: DWORD;
  sDescription: PAnsiChar; dwFlags: DWORD; pbSignature: PBYTE;
  pdwSigLen: PDWORD): BOOL; stdcall;

function CryptSignHash(hHash: HCRYPTHASH; dwKeySpec: DWORD;
  sDescription: LPAWSTR; dwFlags: DWORD; pbSignature: PBYTE; pdwSigLen: PDWORD)
  : BOOL; stdcall;

function CryptSignHashW(hHash: HCRYPTHASH; dwKeySpec: DWORD;
  sDescription: PWideChar; dwFlags: DWORD; pbSignature: PBYTE;
  pdwSigLen: PDWORD): BOOL; stdcall;

function CryptSignHashU(hHash: HCRYPTHASH; dwKeySpec: DWORD;
  sDescription: PWideChar; dwFlags: DWORD; pbSignature: PBYTE;
  pdwSigLen: PDWORD): BOOL; stdcall;
...
type
  ...
  CRYPT_OID_INFO = record
    ...
    EnumValue:
      record { type EnumValue for the union part of the original struct --max-- }
      case integer of
        0:
          (dwValue: DWORD);
        1:
...
function CryptMsgGetParam(HCRYPTMSG: HCRYPTMSG; dwParamType: DWORD;
  dwIndex: DWORD; pvData: PVOID; pcbData: PDWORD): BOOL; stdcall;
...
function CertOpenStore(lpszStoreProvider: LPCSTR; dwEncodingType: DWORD;
  HCRYPTPROV: HCRYPTPROV; dwFlags: DWORD; const pvPara: PVOID)
  : HCERTSTORE; stdcall;
...
type
  PFN_CERT_DLL_OPEN_STORE_PROV_FUNC = function(lpszStoreProvider: LPCSTR;
    dwEncodingType: DWORD; HCRYPTPROV: HCRYPTPROV; dwFlags: DWORD;
...
function CertSetCertificateContextProperty(pCertContext: PCCERT_CONTEXT;
  dwPropId: DWORD; dwFlags: DWORD; pvData: PVOID): BOOL; stdcall;
// +-------------------------------------------------------------------------
...
function CertVerifyRevocation(dwEncodingType: DWORD; dwRevType: DWORD;
  cContext: DWORD; rgpvContext: array of PVOID; dwFlags: DWORD;
  pRevPara: PCERT_REVOCATION_PARA; pRevStatus: PCERT_REVOCATION_STATUS)
  : BOOL; stdcall;
...
function CryptSignMessage(pSignPara: PCRYPT_SIGN_MESSAGE_PARA;
  fDetachedSignature: BOOL; cToBeSigned: DWORD;
  const rgpbToBeSigned: array of PBYTE; rgcbToBeSigned: array of DWORD;
...
function CryptVerifyMessageSignature(pVerifyPara: PCRYPT_VERIFY_MESSAGE_PARA;
  ...
  pbDecoded: PBYTE; pcbDecoded: DWORD; ppSignerCert: PCCERT_CONTEXT)
  : BOOL; stdcall;
// +-------------------------------------------------------------------------
...
function CryptVerifyDetachedMessageSignature(pVerifyPara
  ...
  cToBeSigned: DWORD; const rgpbToBeSigned: array of PBYTE;
...
function CryptDecryptAndVerifyMessageSignature(pDecryptPara
  ...
  pbDecrypted: PBYTE; pcbDecrypted: PDWORD;
  var ppXchgCert: array of PCCERT_CONTEXT;
  var ppSignerCert: array of PCCERT_CONTEXT): BOOL; stdcall;
// +-------------------------------------------------------------------------
...
function CryptHashMessage(pHashPara: PCRYPT_HASH_MESSAGE_PARA;
  fDetachedHash: BOOL; cToBeHashed: DWORD; const rgpbToBeHashed: array of PBYTE;

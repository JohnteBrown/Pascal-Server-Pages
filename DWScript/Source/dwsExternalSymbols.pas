...
type
  ...
  IExternalSymbolHandler = interface
    ...
    procedure Assign(exec: TdwsExecution; symbol: TDataSymbol; expr: TTypedExpr;
      var handled: Boolean);
    procedure Eval(exec: TdwsExecution; symbol: TDataSymbol;
      var handled: Boolean; var result: Variant);
  end;
  ...
  public
    ...
    procedure Eval(exec: TdwsExecution; symbol: TDataSymbol;
      var handled: Boolean; var result: Variant); virtual;

    class procedure Register(symbol: TSymbol;
      const handler: IExternalSymbolHandler); static;

    class procedure HandleAssign(exec: TdwsExecution; symbol: TDataSymbol;
      expr: TTypedExpr; var handled: Boolean); static;
    class procedure HandleEval(exec: TdwsExecution; symbol: TDataSymbol;
      var handled: Boolean; var result: Variant); static;
  end;
...
// Compare
//
function TSymbolHandlersList.Compare(const item1,
  item2: TSymbolHandlers): Integer;
begin
...
// Assign
//
procedure TExternalSymbolHandler.Assign(exec: TdwsExecution;
  symbol: TDataSymbol; expr: TTypedExpr; var handled: Boolean);
begin
  handled := False;
end;
...
// Eval
//
procedure TExternalSymbolHandler.Eval(exec: TdwsExecution; symbol: TDataSymbol;
  var handled: Boolean; var result: Variant);
begin
  handled := False;
end;
...
// Register
//
class procedure TExternalSymbolHandler.Register(symbol: TSymbol;
  const handler: IExternalSymbolHandler);
var
  i: Integer;
  h: TSymbolHandlers;
begin
...
// HandleAssign
//
class procedure TExternalSymbolHandler.HandleAssign(exec: TdwsExecution;
  symbol: TDataSymbol; expr: TTypedExpr; var handled: Boolean);
var
  h: TSymbolHandlers;
  i: Integer;
begin
  ...
  if h <> nil then
  begin
    for i := 0 to h.FHandlers.Count - 1 do
    begin
...
// HandleEval
//
class procedure TExternalSymbolHandler.HandleEval(exec: TdwsExecution;
  symbol: TDataSymbol; var handled: Boolean; var result: Variant);
var
  h: TSymbolHandlers;
  i: Integer;
begin

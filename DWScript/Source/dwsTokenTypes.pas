...
type
   ...
   TTokenType =
     ...
     ttEXTERNAL, ttREADONLY, ttEXPORT, ttFORWARD, ttINLINE, ttEMPTY, ttIN,
     ...
     ttTIMES, ttDIVIDE, ttPERCENT, ttCARET, ttAT, ttTILDE, ttBACKSLASH,
...
const
   cTokenStrings : array [TTokenType] of String = (
     ...
     'external', 'readonly', 'export', 'forward', 'inline', 'empty', 'in',

...
type
  ...
  public
    ...
    class function InterfaceOffsets: TDynamicArrayInterfaceToOffsets;
      virtual; abstract;
  ...
  TScriptDynamicNativeIntegerArray = class(TScriptDynamicNativeArray,
    IScriptDynArray, IJSONWriteAble)
  protected
    FData: PInt64Array;
    FCapacity: NativeInt;
  ...
  TScriptDynamicNativeFloatArray = class(TScriptDynamicNativeArray,
  ...
  TScriptDynamicNativeStringArray = class(TScriptDynamicNativeArray,
    IScriptDynArray, IJSONWriteAble)
  protected
  ...
  TScriptDynamicNativeVariantArray = class(TScriptDynamicNativeArray,
    IScriptDynArray, IJSONWriteAble)
  protected
    FData: TData;
  ...
  TScriptDynamicNativeInterfaceArray = class
    (TScriptDynamicNativeBaseInterfaceArray, IScriptDynArray)
  public
    procedure AddFromExpr(exec: TdwsExecution; valueExpr: TExprBase);
    function SetFromExpr(index: NativeInt; exec: TdwsExecution;
      valueExpr: TExprBase): Boolean;
  ...
  TScriptDynamicNativeObjectArray = class sealed
    (TScriptDynamicNativeBaseInterfaceArray, IScriptDynArray)
  public
    class function NewInstance: TObject; override;
    procedure FreeInstance; override;
  ...
  TScriptDynamicNativeDynArrayArray = class
    (TScriptDynamicNativeBaseInterfaceArray, IScriptDynArray)
  public
    procedure AddFromExpr(exec: TdwsExecution; valueExpr: TExprBase);
    function SetFromExpr(index: NativeInt; exec: TdwsExecution;
  ...
  TScriptDynamicNativeBooleanArray = class(TScriptDynamicNativeArray,
    IScriptDynArray, IJSONWriteAble)
  protected
    FData: TUInt64DynArray;

  const
    cBlockByteSize = SizeOf(UInt64);

  const
    cBlockBitSize = 64;

  const
    cShiftBlockBitSize = 6;

  const
    cShiftBlockByteSize = 3;

  const
    cMaskBlockBits = (1 shl cShiftBlockBitSize) - 1;
...
procedure CreateNewDynamicArray(elemTyp: TTypeSymbol;
...
begin
  ...
  begin
    ...
    if ct = TBaseStringSymbol then
      ...
      result := TScriptDynamicValueArray.Create(elemTyp)

  end
  else
    result := TScriptDynamicDataArray.Create(elemTyp);
end;
...
// SetAsVariant
//
procedure TScriptDynamicDataArray.SetAsVariant(index: NativeInt;
  const v: Variant);
begin
...
// EvalAsVariant
//
procedure TScriptDynamicDataArray.EvalAsVariant(index: NativeInt;
  var result: Variant);
begin
...
// SetAsInteger
//
procedure TScriptDynamicDataArray.SetAsInteger(index: NativeInt;
  const v: Int64);
begin
...
// SetAsBoolean
//
procedure TScriptDynamicDataArray.SetAsBoolean(index: NativeInt;
  const v: Boolean);
begin
...
// SetAsString
//
procedure TScriptDynamicDataArray.SetAsString(index: NativeInt;
  const v: String);
begin
...
// EvalAsString
//
procedure TScriptDynamicDataArray.EvalAsString(index: NativeInt;
  var result: String);
begin
...
// SetAsInterface
//
procedure TScriptDynamicDataArray.SetAsInterface(index: NativeInt;
  const v: IUnknown);
begin
...
// AddFromExpr
//
procedure TScriptDynamicDataArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
var
  n: NativeInt;
  v: Variant;
...
// SetFromExpr
//
function TScriptDynamicDataArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// HashCode
//
function TScriptDynamicDataArray.HashCode(addr: NativeInt; size: NativeInt)
  : Cardinal;
begin
...
// IndexOfValue
//
function TScriptDynamicDataArray.IndexOfValue(const item: Variant;
...
// IndexOfInteger
//
function TScriptDynamicDataArray.IndexOfInteger(item: Int64;
  fromIndex: NativeInt): NativeInt;
begin
  result := inherited IndexOfValue(item, fromIndex, FArrayLength - 1);
end;
...
// IndexOfFloat
//
function TScriptDynamicDataArray.IndexOfFloat(item: Double;
  fromIndex: NativeInt): NativeInt;
begin
  result := inherited IndexOfValue(item, fromIndex, FArrayLength - 1);
end;
...
// IndexOfString
//
function TScriptDynamicDataArray.IndexOfString(const item: String;
  fromIndex: NativeInt): NativeInt;
begin
  result := inherited IndexOfValue(item, fromIndex, FArrayLength - 1);
end;
...
// IndexOfInterface
//
function TScriptDynamicDataArray.IndexOfInterface(const item: IUnknown;
  fromIndex: NativeInt): NativeInt;
begin
  result := inherited IndexOfValue(item, fromIndex, FArrayLength - 1);
end;
...
// IndexOfFuncPtr
//
function TScriptDynamicDataArray.IndexOfFuncPtr(const item: Variant;
  fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
...
// Copy
//
procedure TScriptDynamicDataArray.Copy(src: TScriptDynamicDataArray;
...
// Concat
//
procedure TScriptDynamicDataArray.Concat(const src: IScriptDynArray;
...
begin
  Assert(index >= 0);
  if src.GetSelf.ClassType = Self.ClassType then
  begin
    ...
    begin
      ...
      FArrayLength := n + size;
      SetDataLength(FArrayLength * ElementSize);
      WriteData(n * ElementSize, srcDyn, index * ElementSize,
        size * ElementSize);
    end;
  end
  else
...
begin
  if not vDynamicValueArray.Initialized then
    ...
    result := vDynamicValueArray.CreateInstance;
end;
...
begin
  if FArrayLength = FCapacity then
    Grow;
...
// MoveItem
//
procedure TScriptDynamicNativeIntegerArray.MoveItem(source,
...
begin
  ...
  buf := FData[source];
  if source < destination then
    System.Move(FData[source + 1], FData[source],
      SizeOf(Int64) * (destination - source))
  else
    System.Move(FData[destination], FData[destination + 1],
      SizeOf(Int64) * (source - destination));
...
// IndexOfValue
//
function TScriptDynamicNativeIntegerArray.IndexOfValue(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfInteger
//
function TScriptDynamicNativeIntegerArray.IndexOfInteger(item: Int64;
  fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
begin
...
// IndexOfFloat
//
function TScriptDynamicNativeIntegerArray.IndexOfFloat(item: Double;
  fromIndex: NativeInt): NativeInt;
var
  i: Int64;
begin
...
// IndexOfString
//
function TScriptDynamicNativeIntegerArray.IndexOfString(const item: String;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfInterface
//
function TScriptDynamicNativeIntegerArray.IndexOfInterface(const item: IUnknown;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// IndexOfFuncPtr
//
function TScriptDynamicNativeIntegerArray.IndexOfFuncPtr(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// WriteData
//
procedure TScriptDynamicNativeIntegerArray.WriteData(destAddr: NativeInt;
  const src: IDataContext; srcAddr, size: NativeInt);
var
  i: NativeInt;
begin
  for i := 0 to size - 1 do
...
begin
  ...
  while NativeUInt(pHigh) > NativeUInt(pLow) do
  begin
    t := pLow^;
    pLow^ := pHigh^;
    pHigh^ := t;
...
// Compare
//
function TScriptDynamicNativeIntegerArray.Compare(index1,
...
// AppendString
//
procedure TScriptDynamicNativeIntegerArray.AppendString(index: NativeInt;
  const str: String);
begin
  Assert(False);
end;
...
// SetAsFloat
//
procedure TScriptDynamicNativeIntegerArray.SetAsFloat(index: NativeInt;
  const v: Double);
begin
  FData[index] := Round(v);
end;
...
// SetAsInteger
//
procedure TScriptDynamicNativeIntegerArray.SetAsInteger(index: NativeInt;
  const v: Int64);
begin
  FData[index] := v;
end;
...
// GetAsBoolean
//
function TScriptDynamicNativeIntegerArray.GetAsBoolean
...
// SetAsBoolean
//
procedure TScriptDynamicNativeIntegerArray.SetAsBoolean(index: NativeInt;
  const v: Boolean);
begin
  FData[index] := Ord(v);
end;
...
// SetAsVariant
//
procedure TScriptDynamicNativeIntegerArray.SetAsVariant(index: NativeInt;
  const v: Variant);
begin
...
// EvalAsVariant
//
procedure TScriptDynamicNativeIntegerArray.EvalAsVariant(index: NativeInt;
  var result: Variant);
begin
...
// SetAsString
//
procedure TScriptDynamicNativeIntegerArray.SetAsString(index: NativeInt;
  const v: String);
begin
...
// SetAsInterface
//
procedure TScriptDynamicNativeIntegerArray.SetAsInterface(index: NativeInt;
  const v: IUnknown);
begin
  Assert(False);
end;
...
// AddFromExpr
//
procedure TScriptDynamicNativeIntegerArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
begin
...
// SetFromExpr
//
function TScriptDynamicNativeIntegerArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// HashCode
//
function TScriptDynamicNativeIntegerArray.HashCode(addr: NativeInt;
  size: NativeInt): Cardinal;
var
  i: NativeInt;
begin
  result := cFNV_basis;
...
// InterfaceOffsets
//
class function TScriptDynamicNativeIntegerArray.InterfaceOffsets
  : TDynamicArrayInterfaceToOffsets;
var
...
begin
  ...
  result.ArrayLengthOffset := NativeInt(@instance.FArrayLength) -
    NativeInt(intf);
end;
...
begin
  ...
  if n > FArrayLength then
  begin
    System.FillChar(FData[FArrayLength], (n - FArrayLength) *
      SizeOf(Double), 0);
    FArrayLength := n;
  end
  else
...
// MoveItem
//
procedure TScriptDynamicNativeFloatArray.MoveItem(source,
  destination: NativeInt);
var
  buf: Double;
begin
  ...
  if source < destination then
    System.Move(FData[source + 1], FData[source],
      SizeOf(Double) * (destination - source))
  else
    System.Move(FData[destination], FData[destination + 1],
      SizeOf(Double) * (source - destination));
  FData[destination] := buf;
end;
...
// IndexOfValue
//
function TScriptDynamicNativeFloatArray.IndexOfValue(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfInteger
//
function TScriptDynamicNativeFloatArray.IndexOfInteger(item: Int64;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfFloat
//
function TScriptDynamicNativeFloatArray.IndexOfFloat(item: Double;
  fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
begin
...
// IndexOfString
//
function TScriptDynamicNativeFloatArray.IndexOfString(const item: String;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfInterface
//
function TScriptDynamicNativeFloatArray.IndexOfInterface(const item: IUnknown;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// IndexOfFuncPtr
//
function TScriptDynamicNativeFloatArray.IndexOfFuncPtr(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// WriteData
//
procedure TScriptDynamicNativeFloatArray.WriteData(destAddr: NativeInt;
  const src: IDataContext; srcAddr, size: NativeInt);
var
  i: NativeInt;
begin
...
// Concat
//
procedure TScriptDynamicNativeFloatArray.Concat(const src: IScriptDynArray;
  index, size: NativeInt);
var
  srcSelf: TObject;
...
// Compare
//
function TScriptDynamicNativeFloatArray.Compare(index1,
  index2: NativeInt): Integer;
var
  n1, n2: Double;
begin
...
// AppendString
//
procedure TScriptDynamicNativeFloatArray.AppendString(index: NativeInt;
  const str: String);
begin
  Assert(False);
end;
...
// AsPDouble
//
function TScriptDynamicNativeFloatArray.AsPDouble(var nbElements,
  stride: NativeInt): PDouble;
begin
...
// SetAsFloat
//
procedure TScriptDynamicNativeFloatArray.SetAsFloat(index: NativeInt;
  const v: Double);
begin
  FData[index] := v;
end;
...
// SetAsInteger
//
procedure TScriptDynamicNativeFloatArray.SetAsInteger(index: NativeInt;
  const v: Int64);
begin
  FData[index] := v;
end;
...
// SetAsBoolean
//
procedure TScriptDynamicNativeFloatArray.SetAsBoolean(index: NativeInt;
  const v: Boolean);
begin
  FData[index] := Ord(v);
end;
...
// SetAsVariant
//
procedure TScriptDynamicNativeFloatArray.SetAsVariant(index: NativeInt;
  const v: Variant);
begin
...
// EvalAsVariant
//
procedure TScriptDynamicNativeFloatArray.EvalAsVariant(index: NativeInt;
  var result: Variant);
begin
  VarCopySafe(result, FData[index]);
end;
...
// SetAsString
//
procedure TScriptDynamicNativeFloatArray.SetAsString(index: NativeInt;
  const v: String);
begin
...
// SetAsInterface
//
procedure TScriptDynamicNativeFloatArray.SetAsInterface(index: NativeInt;
  const v: IUnknown);
begin
  Assert(False);
end;
...
// AddFromExpr
//
procedure TScriptDynamicNativeFloatArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
begin
...
// SetFromExpr
//
function TScriptDynamicNativeFloatArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// HashCode
//
function TScriptDynamicNativeFloatArray.HashCode(addr: NativeInt;
  size: NativeInt): Cardinal;
var
  i: NativeInt;
begin
...
// InterfaceOffsets
//
class function TScriptDynamicNativeFloatArray.InterfaceOffsets
  : TDynamicArrayInterfaceToOffsets;
var
...
// MoveItem
//
procedure TScriptDynamicNativeStringArray.MoveItem(source,
  destination: NativeInt);
var
  buf: Pointer;
begin
  ...
  if source < destination then
    System.Move(FData[source + 1], FData[source],
      SizeOf(Pointer) * (destination - source))
  else
    System.Move(FData[destination], FData[destination + 1],
      SizeOf(Pointer) * (source - destination));
...
// IndexOfValue
//
function TScriptDynamicNativeStringArray.IndexOfValue(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfInteger
//
function TScriptDynamicNativeStringArray.IndexOfInteger(item: Int64;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfFloat
//
function TScriptDynamicNativeStringArray.IndexOfFloat(item: Double;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfString
//
function TScriptDynamicNativeStringArray.IndexOfString(const item: String;
  fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
  n: Integer;
...
begin
  if fromIndex < 0 then
    fromIndex := 0;
  if fromIndex < FArrayLength then
  begin
    p := @FData[fromIndex];
    n := Length(item);
    if n = 0 then
    ...
    begin
      for i := fromIndex to FArrayLength - 1 do
      begin
        if (Length(p^) = n) and System.SysUtils.CompareMem(Pointer(p^),
          Pointer(item), n * SizeOf(Char)) then
          Exit(i);
        Inc(p);
      end;
    end;
...
// IndexOfInterface
//
function TScriptDynamicNativeStringArray.IndexOfInterface(const item: IUnknown;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// IndexOfFuncPtr
//
function TScriptDynamicNativeStringArray.IndexOfFuncPtr(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// WriteData
//
procedure TScriptDynamicNativeStringArray.WriteData(destAddr: NativeInt;
  const src: IDataContext; srcAddr, size: NativeInt);
var
  i: NativeInt;
begin
...
// Concat
//
procedure TScriptDynamicNativeStringArray.Concat(const src: IScriptDynArray;
  index, size: NativeInt);
var
  srcSelf: TObject;
...
// Compare
//
function TScriptDynamicNativeStringArray.Compare(index1,
  index2: NativeInt): Integer;
begin
...
// AppendString
//
procedure TScriptDynamicNativeStringArray.AppendString(index: NativeInt;
  const str: String);
begin
...
// SetAsFloat
//
procedure TScriptDynamicNativeStringArray.SetAsFloat(index: NativeInt;
  const v: Double);
begin
...
// SetAsInteger
//
procedure TScriptDynamicNativeStringArray.SetAsInteger(index: NativeInt;
  const v: Int64);
begin
...
// SetAsBoolean
//
procedure TScriptDynamicNativeStringArray.SetAsBoolean(index: NativeInt;
  const v: Boolean);
begin
  if v then
    FData[index] := '1'
...
// SetAsVariant
//
procedure TScriptDynamicNativeStringArray.SetAsVariant(index: NativeInt;
  const v: Variant);
begin
...
// EvalAsVariant
//
procedure TScriptDynamicNativeStringArray.EvalAsVariant(index: NativeInt;
  var result: Variant);
begin
  VarCopySafe(result, FData[index]);
end;
...
// SetAsString
//
procedure TScriptDynamicNativeStringArray.SetAsString(index: NativeInt;
  const v: String);
begin
  FData[index] := v;
end;
...
// EvalAsString
//
procedure TScriptDynamicNativeStringArray.EvalAsString(index: NativeInt;
  var result: String);
begin
  result := FData[index];
end;
...
// SetAsInterface
//
procedure TScriptDynamicNativeStringArray.SetAsInterface(index: NativeInt;
  const v: IUnknown);
begin
  Assert(False);
end;
...
// EvalAsInterface
//
procedure TScriptDynamicNativeStringArray.EvalAsInterface(index: NativeInt;
  var result: IUnknown);
begin
  Assert(False);
end;
...
// AddFromExpr
//
procedure TScriptDynamicNativeStringArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
var
  s: String;
begin
...
// SetFromExpr
//
function TScriptDynamicNativeStringArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
var
  buf: String;
begin
...
// HashCode
//
function TScriptDynamicNativeStringArray.HashCode(addr: NativeInt;
  size: NativeInt): Cardinal;
var
  i: NativeInt;
begin
...
// InterfaceOffsets
//
class function TScriptDynamicNativeStringArray.InterfaceOffsets
  : TDynamicArrayInterfaceToOffsets;
var
...
// MoveItem
//
procedure TScriptDynamicNativeVariantArray.MoveItem(source,
  destination: NativeInt);
var
  buf: TVarData;
begin
...
// IndexOfValue
//
function TScriptDynamicNativeVariantArray.IndexOfValue(const item: Variant;
  fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
  p: PVariant;
...
// IndexOfInteger
//
function TScriptDynamicNativeVariantArray.IndexOfInteger(item: Int64;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfFloat
//
function TScriptDynamicNativeVariantArray.IndexOfFloat(item: Double;
  fromIndex: NativeInt): NativeInt;
begin
  result := IndexOfValue(item, fromIndex);
end;
...
// IndexOfString
//
function TScriptDynamicNativeVariantArray.IndexOfString(const item: String;
  fromIndex: NativeInt): NativeInt;
begin
  result := IndexOfValue(item, fromIndex);
end;
...
// IndexOfInterface
//
function TScriptDynamicNativeVariantArray.IndexOfInterface(const item: IUnknown;
  fromIndex: NativeInt): NativeInt;
begin
  result := IndexOfValue(item, fromIndex);
end;
...
// IndexOfFuncPtr
//
function TScriptDynamicNativeVariantArray.IndexOfFuncPtr(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
  result := IndexOfValue(item, fromIndex);
end;
...
// WriteData
//
procedure TScriptDynamicNativeVariantArray.WriteData(destAddr: NativeInt;
  const src: IDataContext; srcAddr, size: NativeInt);
var
  i: NativeInt;
begin
...
// Concat
//
procedure TScriptDynamicNativeVariantArray.Concat(const src: IScriptDynArray;
  index, size: NativeInt);
var
  srcSelf: TObject;
...
// Compare
//
function TScriptDynamicNativeVariantArray.Compare(index1,
  index2: NativeInt): Integer;
begin
...
// AppendString
//
procedure TScriptDynamicNativeVariantArray.AppendString(index: NativeInt;
  const str: String);
begin
...
// SetAsFloat
//
procedure TScriptDynamicNativeVariantArray.SetAsFloat(index: NativeInt;
  const v: Double);
begin
...
// SetAsInteger
//
procedure TScriptDynamicNativeVariantArray.SetAsInteger(index: NativeInt;
  const v: Int64);
begin
  VarCopySafe(FData[index], v);
end;
...
// GetAsBoolean
//
function TScriptDynamicNativeVariantArray.GetAsBoolean
  (index: NativeInt): Boolean;
begin
...
// SetAsBoolean
//
procedure TScriptDynamicNativeVariantArray.SetAsBoolean(index: NativeInt;
  const v: Boolean);
begin
  VarCopySafe(FData[index], v);
end;
...
// SetAsVariant
//
procedure TScriptDynamicNativeVariantArray.SetAsVariant(index: NativeInt;
  const v: Variant);
begin
  VarCopySafe(FData[index], v);
end;
...
// EvalAsVariant
//
procedure TScriptDynamicNativeVariantArray.EvalAsVariant(index: NativeInt;
  var result: Variant);
begin
  VarCopySafe(result, FData[index]);
end;
...
// SetAsString
//
procedure TScriptDynamicNativeVariantArray.SetAsString(index: NativeInt;
  const v: String);
begin
  VarCopySafe(FData[index], v);
end;
...
// EvalAsString
//
procedure TScriptDynamicNativeVariantArray.EvalAsString(index: NativeInt;
  var result: String);
begin
...
// SetAsInterface
//
procedure TScriptDynamicNativeVariantArray.SetAsInterface(index: NativeInt;
  const v: IUnknown);
begin
  VarCopySafe(FData[index], v);
end;
...
// EvalAsInterface
//
procedure TScriptDynamicNativeVariantArray.EvalAsInterface(index: NativeInt;
  var result: IUnknown);
begin
  result := FData[index];
end;
...
// AddFromExpr
//
procedure TScriptDynamicNativeVariantArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
var
  v: Variant;
begin
...
// SetFromExpr
//
function TScriptDynamicNativeVariantArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// HashCode
//
function TScriptDynamicNativeVariantArray.HashCode(addr: NativeInt;
  size: NativeInt): Cardinal;
begin
...
// InterfaceOffsets
//
class function TScriptDynamicNativeVariantArray.InterfaceOffsets
  : TDynamicArrayInterfaceToOffsets;
var
...
// Delete
//
procedure TScriptDynamicNativeBaseInterfaceArray.Delete(index,
  count: NativeInt);
begin
  System.Delete(FData, index, count);
  Dec(FArrayLength, count);
...
// MoveItem
//
procedure TScriptDynamicNativeBaseInterfaceArray.MoveItem(source,
  destination: NativeInt);
var
  buf: Pointer;
begin
...
// Swap
//
procedure TScriptDynamicNativeBaseInterfaceArray.Swap(index1,
  index2: NativeInt);
begin
  SwapPointers(PPointer(@FData[index1])^, PPointer(@FData[index2])^);
end;
...
// IndexOfValue
//
function TScriptDynamicNativeBaseInterfaceArray.IndexOfValue
  (const item: Variant; fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfInteger
//
function TScriptDynamicNativeBaseInterfaceArray.IndexOfInteger(item: Int64;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// IndexOfFloat
//
function TScriptDynamicNativeBaseInterfaceArray.IndexOfFloat(item: Double;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// IndexOfString
//
function TScriptDynamicNativeBaseInterfaceArray.IndexOfString
  (const item: String; fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// IndexOfInterface
//
function TScriptDynamicNativeBaseInterfaceArray.IndexOfInterface
  (const item: IUnknown; fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
begin
  for i := fromIndex to FArrayLength - 1 do
...
// IndexOfFuncPtr
//
function TScriptDynamicNativeBaseInterfaceArray.IndexOfFuncPtr
  (const item: Variant; fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
  itemFunc: IFuncPointer;
...
// WriteData
//
procedure TScriptDynamicNativeBaseInterfaceArray.WriteData(destAddr: NativeInt;
  const src: IDataContext; srcAddr, size: NativeInt);
var
  i: NativeInt;
begin
...
// Concat
//
procedure TScriptDynamicNativeBaseInterfaceArray.Concat
  (const src: IScriptDynArray; index, size: NativeInt);
var
  srcSelf: TObject;
...
// Compare
//
function TScriptDynamicNativeBaseInterfaceArray.Compare(index1,
  index2: NativeInt): NativeInt;
begin
  result := 0;
end;
...
// AppendString
//
procedure TScriptDynamicNativeBaseInterfaceArray.AppendString(index: NativeInt;
  const str: String);
begin
  Assert(False);
end;
...
// GetAsFloat
//
function TScriptDynamicNativeBaseInterfaceArray.GetAsFloat
  (index: NativeInt): Double;
begin
  Assert(False);
  result := 0;
end;
...
// SetAsFloat
//
procedure TScriptDynamicNativeBaseInterfaceArray.SetAsFloat(index: NativeInt;
  const v: Double);
begin
  Assert(False);
end;
...
// GetAsInteger
//
function TScriptDynamicNativeBaseInterfaceArray.GetAsInteger
  (index: NativeInt): Int64;
begin
  Assert(False);
  result := 0;
end;
...
// SetAsInteger
//
procedure TScriptDynamicNativeBaseInterfaceArray.SetAsInteger(index: NativeInt;
  const v: Int64);
begin
  Assert(False);
end;
...
// GetAsBoolean
//
function TScriptDynamicNativeBaseInterfaceArray.GetAsBoolean
  (index: NativeInt): Boolean;
begin
  Assert(False);
  result := False;
...
// SetAsBoolean
//
procedure TScriptDynamicNativeBaseInterfaceArray.SetAsBoolean(index: NativeInt;
  const v: Boolean);
begin
  Assert(False);
end;
...
// SetAsVariant
//
procedure TScriptDynamicNativeBaseInterfaceArray.SetAsVariant(index: NativeInt;
  const v: Variant);
begin
  FData[index] := v;
end;
...
// EvalAsVariant
//
procedure TScriptDynamicNativeBaseInterfaceArray.EvalAsVariant(index: NativeInt;
  var result: Variant);
begin
  VarCopySafe(result, FData[index]);
end;
...
// SetAsString
//
procedure TScriptDynamicNativeBaseInterfaceArray.SetAsString(index: NativeInt;
  const v: String);
begin
  Assert(False);
end;
...
// EvalAsString
//
procedure TScriptDynamicNativeBaseInterfaceArray.EvalAsString(index: NativeInt;
  var result: String);
begin
...
// SetAsInterface
//
procedure TScriptDynamicNativeBaseInterfaceArray.SetAsInterface
  (index: NativeInt; const v: IUnknown);
begin
  FData[index] := v;
end;
...
// EvalAsInterface
//
procedure TScriptDynamicNativeBaseInterfaceArray.EvalAsInterface
  (index: NativeInt; var result: IUnknown);
begin
  result := FData[index];
end;
...
// IsEmpty
//
function TScriptDynamicNativeBaseInterfaceArray.IsEmpty
  (addr: NativeInt): Boolean;
begin
  result := False;
end;
...
// VarType
//
function TScriptDynamicNativeBaseInterfaceArray.VarType(addr: NativeInt)
  : TVarType;
begin
  result := varUnknown;
end;
...
// HashCode
//
function TScriptDynamicNativeBaseInterfaceArray.HashCode(addr: NativeInt;
  size: NativeInt): Cardinal;
var
  i: NativeInt;
begin
...
// InterfaceOffsets
//
class function TScriptDynamicNativeBaseInterfaceArray.InterfaceOffsets
  : TDynamicArrayInterfaceToOffsets;
var
...
// SetFromExpr
//
function TScriptDynamicNativeInterfaceArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// AddFromExpr
//
procedure TScriptDynamicNativeInterfaceArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
var
  i: IInterface;
begin
...
//
var
  vDynamicNativeObjectArrayTemplate
    : TClassInstanceTemplate<TScriptDynamicNativeObjectArray>;
...
begin
  if not vDynamicNativeObjectArrayTemplate.Initialized then
    ...
    result := vDynamicNativeObjectArrayTemplate.CreateInstance;
end;
...
// SetFromExpr
//
function TScriptDynamicNativeObjectArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// AddFromExpr
//
procedure TScriptDynamicNativeObjectArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
var
  i: IInterface;
begin
...
begin
  ...
  CreateNewDynamicArray(ElementTyp.UnAliasedType.Typ,
    IScriptDynArray(FData[index]));
end;

// SetFromExpr
//
function TScriptDynamicNativeDynArrayArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// AddFromExpr
//
procedure TScriptDynamicNativeDynArrayArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
var
  i: IInterface;
begin
...
// InterfaceOffsets
//
class function TScriptDynamicNativeBooleanArray.InterfaceOffsets
  : TDynamicArrayInterfaceToOffsets;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if tailBits > 0 then
        FData[blockCount - 1] := FData[blockCount - 1] and
          (UInt64(-1) shr tailBits);
    end;
  end;
  FArrayLength := n;
end;
...
// MoveItem
//
procedure TScriptDynamicNativeBooleanArray.MoveItem(source,
  destination: NativeInt);
var
  buf: Boolean;
  i: NativeInt;
...
// IndexOfValue
//
function TScriptDynamicNativeBooleanArray.IndexOfValue(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
  result := IndexOfInteger(VariantToInt64(item), fromIndex);
end;
...
// IndexOfInteger
//
function TScriptDynamicNativeBooleanArray.IndexOfInteger(item: Int64;
  fromIndex: NativeInt): NativeInt;
var
  i: NativeInt;
  v: Boolean;
...
// IndexOfFloat
//
function TScriptDynamicNativeBooleanArray.IndexOfFloat(item: Double;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfString
//
function TScriptDynamicNativeBooleanArray.IndexOfString(const item: String;
  fromIndex: NativeInt): NativeInt;
begin
...
// IndexOfInterface
//
function TScriptDynamicNativeBooleanArray.IndexOfInterface(const item: IUnknown;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// IndexOfFuncPtr
//
function TScriptDynamicNativeBooleanArray.IndexOfFuncPtr(const item: Variant;
  fromIndex: NativeInt): NativeInt;
begin
  result := -1;
end;
...
// WriteData
//
procedure TScriptDynamicNativeBooleanArray.WriteData(destAddr: NativeInt;
  const src: IDataContext; srcAddr, size: NativeInt);
var
  i: NativeInt;
begin
...
// Concat
//
procedure TScriptDynamicNativeBooleanArray.Concat(const src: IScriptDynArray;
  index, size: NativeInt);
var
  srcSelf: TObject;
...
// Compare
//
function TScriptDynamicNativeBooleanArray.Compare(index1, index2: NativeInt)
  : NativeInt;
begin
...
// AppendString
//
procedure TScriptDynamicNativeBooleanArray.AppendString(index: NativeInt;
  const str: String);
begin
  Assert(False);
end;
...
// SetAsFloat
//
procedure TScriptDynamicNativeBooleanArray.SetAsFloat(index: NativeInt;
  const v: Double);
begin
...
// SetAsInteger
//
procedure TScriptDynamicNativeBooleanArray.SetAsInteger(index: NativeInt;
  const v: Int64);
begin
  SetAsBoolean(index, v <> 0);
end;
...
// GetAsBoolean
//
function TScriptDynamicNativeBooleanArray.GetAsBoolean
  (index: NativeInt): Boolean;
var
  p: PUInt64;
  mask: UInt64;
  bitSubIndex: Integer;
begin
  p := PUInt64(IntPtr(FData) + ((index shr cShiftBlockBitSize)
    shl cShiftBlockByteSize));
...
// SetAsBoolean
//
procedure TScriptDynamicNativeBooleanArray.SetAsBoolean(index: NativeInt;
  const v: Boolean);
var
  p: PUInt64;
  mask: UInt64;
...
// SetAsVariant
//
procedure TScriptDynamicNativeBooleanArray.SetAsVariant(index: NativeInt;
  const v: Variant);
begin
...
// EvalAsVariant
//
procedure TScriptDynamicNativeBooleanArray.EvalAsVariant(index: NativeInt;
  var result: Variant);
begin
...
// SetAsString
//
procedure TScriptDynamicNativeBooleanArray.SetAsString(index: NativeInt;
  const v: String);
begin
...
// SetAsInterface
//
procedure TScriptDynamicNativeBooleanArray.SetAsInterface(index: NativeInt;
  const v: IUnknown);
begin
  Assert(False);
end;
...
// AddFromExpr
//
procedure TScriptDynamicNativeBooleanArray.AddFromExpr(exec: TdwsExecution;
  valueExpr: TExprBase);
begin
...
// SetFromExpr
//
function TScriptDynamicNativeBooleanArray.SetFromExpr(index: NativeInt;
  exec: TdwsExecution; valueExpr: TExprBase): Boolean;
begin
  if BoundsCheckPassed(index) then
  begin
...
// HashCode
//
function TScriptDynamicNativeBooleanArray.HashCode(addr: NativeInt;
  size: NativeInt): Cardinal;
var
  i: NativeInt;
begin
